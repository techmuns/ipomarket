...
Generated: 2026-09-22T08:30:17.110Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 232 | Use as primary source for Live & Upcoming tab. |
| P-02 | NSE — Upcoming IPOs | GREEN | 200 | JSON | 22 | Use as primary for Upcoming/Pipeline tab. |
| P-03 | NSE — Past/Recent IPOs | GREEN | 200 | JSON | 21 | Use as primary for Recently Listed. |
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 385 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 726 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 4180 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | RED | 0 | ERROR | 1516 | Download failed; fall back to P-10 exchange-side DRHP archive. |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11200 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 3108 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 54 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 229 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 407 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10276 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 316 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 51 | Fall back to per-issue page scrape or manual seed. |
...
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 1052 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 779 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 1028 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 280 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1492 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1495 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 200 | HTML | 339 | Skip. |
| P-22 | GMP — InvestorGain | RED | 200 | HTML | 52 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 5369 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5973 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
...
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 1459 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3467 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 5208 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 1893 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 232 ms
- Ran at (UTC): 2026-09-22T08:29:08.997Z

> Total rows: 10, Active rows: 1

```
{
  "companyName": "Varmora Granito Limited",
  "issueEndDate": "24-Sep-2026",
  "issuePrice": "Rs.140 to Rs.148",
  "issueSize": "33902899",
...
> Total rows: 10, Forthcoming/upcoming rows: 7
...
- URL: `https://www.nseindia.com/api/ipo-current-issue?symbol=VARMORA`
...
> Active candidate symbol: VARMORA · Top-level keys: 0, 1
...
[
  {
    ...
    "symbol": "VARMORA",
    "category": "Total",
    "noOfSharesOffered": "3.3902899E7",
    "noOfTime": "0.055944448880315516",
    "noOfsharesBid": "1896679.0",
    "srNo": null
  },
  {
    "companyName": "Axiom Gas Engineering Limited",
    "isBse": "1",
    "issueEndDate": "22-Sep-2026",
    "issueStartDate": "18-Sep-2026",
    "series": "SME",
    "status": "Active",
    "symbol": "AXIOMGAS",
    "noOfsharesBid": "9976000",
    "noOfSharesOffered": "8328000",
    "noOfTime": "1.20"
  }
]
```
...
> [static-primary] static ok: tr=0, bytes=6035 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=44946 (pdfs=15)
...
> Sample URL: https://www.sebi.gov.in/sebi_data/commondocs/sep-2026/HitechFlowSolutionsDAP_p.pdf; status=0 bytes=0
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22095 chars] ; [bse:RELIANCE] BSE rows=19112, fields=1

```
{
  "CurrDate": "Tue Sep 22 2026 13:58:59",
  "PrevClose": "1247.7",
  "LowVal": "1235",
  "HighVal": "1255",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "150000",
  "Data": "[{\"dttm\":\"Tue Sep 22 2026 13:58:59\",\"vale1\":\"1239.10\",\"vole\":\"2421\"},{\"dttm\":\"Tue Sep 22 2026 13:57:59\",\"vale1\":\"1238.15\",\"vole\":\"1660\"},{\"dttm\":\"Tue Sep 22 2026 13:56:59\",\"vale1\":\"1238.80\",\"vole\":\"447\"},{\"dttm\":\"Tue Sep 22 2026 13:55:59\",\"vale1\":\"1239.00\",\"vole\":\"739\"},{\"dttm\":\"Tue Sep 22 2026 13:54:59\",\"vale1\":\"1238.25\",\"vole\":\"2605\"},{\"dttm\":\"Tue Sep 22 2026 13:53:59\",\"vale1\":\"1239.40\",\"vole\":\"156\"},{\"dttm\":\"Tue Sep 22 2026 13:52:59\",\"vale1\":\"1239.60\",\"vole\":\"478\"},{\"dttm\…[truncated, total 22758 chars]
```
...
Reference&#32;&#35;18&#46;e44f4317&#46;1790065771&#46;19906894
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;e44f4317&#46;1790065771&#46;19906894</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 964262 chars]
```
...
> <tr> count: 0, bytes=554306

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP Today 2026 – Live Grey Market Premium &amp; Kostak Rates - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-cfasync="fa…[truncated, total 554306 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=347228 | rendered_len=391771 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
<H1>Access Denied</H1>
 …[truncated, total 397 chars] ; [NSE IPO list] 10 IPOs; per-row keys: companyName, issueEndDate, issuePrice, issueSize, issueStartDate, series, status, symbol; sector fields: (none) ; [BSE IPO list] BSE HTML; sector-related words found: (none); bytes=14287
...
> mainboard: static status=200 bytes=149182 | sme: static status=200 bytes=149541 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=282656 | detail-2: static status=200 bytes=282741 | challenges_detected=false
...
```
{
  ...
  "picked_detail_urls": [
    ...
    "https://www.chittorgarh.com/ipo/orient-cables-ipo/2532/"
  ],
  "detail_titles": [
    "Acevector IPO Date, Price, GMP, Review, Analysis &amp; Details",
    "Orient Cables IPO Date, Price, GMP, Review, Details"
  ],
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=2 | d1: main=84252b tables=12 rows=71 | d2: main=84351b tables=12 rows=66
...
```
{
  ...
  "details": [
    ...
    {
      "index": 2,
      "source_url": "https://www.chittorgarh.com/ipo/orient-cables-ipo/2532/",
      "found_count": 5,
      "precision_ratio": 0.5,
      "tables_parsed": 12,
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=347228 | rendered_len=391182 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (varmora-granito-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
```
{
  ...
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "Varmora Granito IPO Date, Price, GMP, Review, Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.848 | avg_narrow=1.000 | pdf_on_allowlist=2 | pdf_off_allowlist=2 | third_ipo=varmora-granito-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.82 narrow=1.00 | d3:varmora-granito-ipo full=0.82 narrow=1.00
