...
Generated: 2026-07-13T06:30:19.496Z
...
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2018 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 304 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2859 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11376 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 5656 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 24 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 301 | Deterministic mapping; no manual override file needed for v1. |
...
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 425 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 327 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 783 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 209 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 4959 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 1333 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 1011 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 260 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 10480 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1312 | Skip; Phase 6 stays off if all GMP probes fail. |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3497 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4348 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 144 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 295 ms
- Ran at (UTC): 2026-07-13T06:28:59.522Z
...
[
  {
    ...
    "noOfTime": "2.5385697067173734",
    "noOfsharesBid": "6.495237E7",
    "srNo": null
  },
  {
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=11070, fields=1

```
{
  "CurrDate": "Mon Jul 13 2026 11:58:59",
  "PrevClose": "1308.85",
  "LowVal": "1295",
  "HighVal": "1310",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "75000",
  "Data": "[{\"dttm\":\"Mon Jul 13 2026 11:58:59\",\"vale1\":\"1297.50\",\"vole\":\"166\"},{\"dttm\":\"Mon Jul 13 2026 11:57:59\",\"vale1\":\"1297.50\",\"vole\":\"435\"},{\"dttm\":\"Mon Jul 13 2026 11:56:59\",\"vale1\":\"1297.85\",\"vole\":\"451\"},{\"dttm\":\"Mon Jul 13 2026 11:55:59\",\"vale1\":\"1297.40\",\"vole\":\"744\"},{\"dttm\":\"Mon Jul 13 2026 11:54:59\",\"vale1\":\"1297.35\",\"vole\":\"275\"},{\"dttm\":\"Mon Jul 13 2026 11:53:59\",\"vale1\":\"1297.50\",\"vole\":\"1838\"},{\"dttm\":\"Mon Jul 13 2026 11:52:58\",\"vale1\":\"1297.70\",\"vole\":\"562\"},{\"dttm\":…[truncated, total 13276 chars]
```
...
Reference&#32;&#35;18&#46;9f1fc917&#46;1783924164&#46;fc304b0
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;9f1fc917&#46;1783924164&#46;fc304b0</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 822332 chars]
```
...
```
<!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=Edge"><meta name="robots" content="noindex,nofollow"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="content-security-policy" content="default-src &#39;none&#39;; script-src &#39;nonce-4MW8DEJp4icdWd9yZmImXY&#39; &#39;unsafe-eval&#39; https://challenges.cloudflare.com; script-s…[truncated, total 5747 chars]
```
...
> mainboard: static status=200 bytes=147531 | sme: static status=200 bytes=145867 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=279369 | detail-2: static status=200 bytes=292254 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=1 | d1: main=83389b tables=10 rows=57 | d2: main=87269b tables=11 rows=72
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=266714 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
