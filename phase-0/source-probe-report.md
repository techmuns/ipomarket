...
Generated: 2026-05-23T09:33:20.304Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | YELLOW | 200 | JSON | 20311 | Source reachable but 0 rows in current snapshot. category=ipo appears to be mainboard-only; if today's only IPOs are SME, P-05 should satisfy the IPO-list-source gate. |
| P-02 | NSE — Upcoming IPOs | YELLOW | 200 | JSON | 81 | Source reachable but 0 upcoming rows in current snapshot. category=ipo is mainboard-only; SME pipeline lives in P-05. |
| P-03 | NSE — Past/Recent IPOs | YELLOW | 200 | JSON | 59 | Source reachable but 0 rows in current snapshot. category=ipo is mainboard-only; recently-listed SMEs require P-05. |
...
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 41217 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2188 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 3626 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 10993 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 81564 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | GREEN | 200 | JSON | 352 | Use as primary for current price. |
| P-16 | Ticker mapping (NSE list symbol field) | RED | 200 | JSON | 20493 | Maintain a manual override file for IPOs whose symbol drifts post-listing. |
...
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 383 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 391 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 1190 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 162 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 5466 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 1114 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 638 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 233 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1966 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1109 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 403 | BLOCKED | 94 | Skip. |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 386 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 5553 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
...
| P-24 | Sector / industry classification (NSE + BSE) | RED | 200 | EMPTY | 21663 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 1077 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4291 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 1042 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Latency: 20311 ms
- Ran at (UTC): 2026-05-23T09:29:07.587Z
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 815669 chars]
```
...
```
<!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=Edge"><meta name="robots" content="noindex,nofollow"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="content-security-policy" content="default-src &#39;none&#39;; script-src &#39;nonce-YV6COO707C96VYO3DXGlH9&#39; &#39;unsafe-eval&#39; https://challenges.cloudflare.com; script-s…[truncated, total 5726 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=224411 | rendered_len=265723 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> [NSE equity quote] top-level keys: data, msg; sector fields: (none) ; [NSE IPO list] NSE IPO list returned 0 items ; [BSE IPO list] BSE HTML; sector-related words found: (none); bytes=12565
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=224411 | rendered_len=266856 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
