...
Generated: 2026-09-01T15:29:40.942Z
...
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 485 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 1106 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2950 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 352 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2855 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11096 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 14275 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 98 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 1088 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 877 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10105 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 332 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 991 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 799 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 2334 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 1078 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 772 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 905 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 238 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1773 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1520 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 331 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
| P-22 | GMP — InvestorGain | RED | 200 | HTML | 119 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 5239 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5616 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 987 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3716 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 5985 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 2573 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 452 ms
- Ran at (UTC): 2026-09-01T15:28:15.040Z
...
- URL: `https://www.nseindia.com/api/ipo-current-issue?symbol=DEEPA`
...
> Active candidate symbol: DEEPA · Top-level keys: 0, 1, 2, 3, 4, 5, 6
...
[
  {
    ...
    "noOfTime": "0.5045011402485464",
    "noOfsharesBid": "9343404.0",
    "srNo": null
  },
  {
    "companyName": "Rays of Belief Limited- For Profit Social Enterprise (FPSE)",
    "issueEndDate": "03-Sep-2026",
    "issuePrice": "Rs.227 to Rs.239",
    "issueSize": "3137810",
    "issueStartDate": "01-Sep-2026",
    "series": "EQ",
    "status": "Active",
    ...
    "noOfTime": "0.77451…[truncated, total 2748 chars]
```
...
> [static-primary] static ok: tr=0, bytes=6080 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=46582 (pdfs=20)
...
> discovery=sebi-publicissues-pdfs.json; pdf_url=%20Infra%20Limited%20-%20Draft%20Abridged%20Prospectus_p.pdf; bytes=567567; page_count=15; pdf-parse=ok
...
```
{
  ...
  "link_text": "Sembcorp Green Infra Limited - Draft Abridged Prospectus",
  "bytes": 567567,
  "sha256": "1e2bca24164d6142…",
  "magic": "%PDF",
  "page_count": 15,
  "cover_text_first_200": "SEMBCORP GREEN INFRA LIMITED\nCORPORATE IDENTITY NUMBER: U23200HR2005PLC078211\nREGISTERED AND CONTACT E-MAIL AND WEBSITE\nCORPORATE OFFICE PERSON TELEPHONE\nBuilding 7A, Level 5, DLF Ande Narendra, Email"
}
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=26613, fields=1

```
{
  "CurrDate": "Tue Sep 01 2026 16:01:16",
  "PrevClose": "1285",
  "LowVal": "1280",
  "HighVal": "1320",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "100000",
  "Data": "[{\"dttm\":\"Tue Sep 01 2026 16:01:16\",\"vale1\":\"1307.35\",\"vole\":\"0\"},{\"dttm\":\"Tue Sep 01 2026 16:00:01\",\"vale1\":\"1307.35\",\"vole\":\"0\"},{\"dttm\":\"Tue Sep 01 2026 15:59:42\",\"vale1\":\"1307.35\",\"vole\":\"21\"},{\"dttm\":\"Tue Sep 01 2026 15:58:44\",\"vale1\":\"1307.35\",\"vole\":\"20\"},{\"dttm\":\"Tue Sep 01 2026 15:57:24\",\"vale1\":\"1307.35\",\"vole\":\"10001\"},{\"dttm\":\"Tue Sep 01 2026 15:56:48\",\"vale1\":\"1307.35\",\"vole\":\"23001\"},{\"dttm\":\"Tue Sep 01 2026 15:55:53\",\"vale1\":\"1307.35\",\"vole\":\"22026\"},{\"dttm\":\"T…[truncated, total 31589 chars]
```
...
Reference&#32;&#35;18&#46;e9f12417&#46;1788276530&#46;78b5a725
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;e9f12417&#46;1788276530&#46;78b5a725</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 913647 chars]
```
...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="pingback" href="https://ipocentral.in/x…[truncated, total 506289 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=355978 | rendered_len=400151 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=150829 | sme: static status=200 bytes=150973 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=254107 | detail-2: static status=200 bytes=260095 | challenges_detected=false
...
```
{
  ...
  "picked_detail_urls": [
    ...
    "https://www.chittorgarh.com/ipo/veegaland-developers-ipo/2834/"
  ],
  "detail_titles": [
    "Kanohar Electricals IPO Date, Price, GMP, Review, Details",
    "Veegaland Developers IPO Date, Price, GMP, Review, Details"
  ],
...
> details_extracted=2 | avg_precision=0.350 | official_pdf_links_on_allowlist=1 | official_pdf_links_off_allowlist=0 | d1: main=75302b tables=10 rows=51 | d2: main=79284b tables=10 rows=54
...
```
{
  ...
  "details": [
    ...
    {
      "index": 2,
      "source_url": "https://www.chittorgarh.com/ipo/veegaland-developers-ipo/2834/",
      "found_count": 5,
      "precision_ratio": 0.5,
      "tables_parsed": 10,
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=355978 | rendered_len=401350 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (deepa-jewellers-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
```
{
  ...
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "Deepa Jewellers IPO Date, Price, GMP, Review, Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.848 | avg_narrow=1.000 | pdf_on_allowlist=2 | pdf_off_allowlist=1 | third_ipo=deepa-jewellers-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.82 narrow=1.00 | d3:deepa-jewellers-ipo full=0.82 narrow=1.00
