...
Generated: 2026-08-12T11:58:09.796Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 314 | Use as primary source for Live & Upcoming tab. |
| P-02 | NSE — Upcoming IPOs | GREEN | 200 | JSON | 60 | Use as primary for Upcoming/Pipeline tab. |
| P-03 | NSE — Past/Recent IPOs | GREEN | 200 | JSON | 88 | Use as primary for Recently Listed. |
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 352 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 944 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2733 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2936 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11570 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 8459 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 116 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 412 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 987 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10131 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 276 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 40 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 411 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 153 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 964 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 663 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 1134 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 214 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 10905 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 570 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 115 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 49 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4531 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4951 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 548 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 92 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3555 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4928 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 1004 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 314 ms
- Ran at (UTC): 2026-08-12T11:56:51.620Z
...
> Total rows: 8, Forthcoming/upcoming rows: 3
...
- URL: `https://www.nseindia.com/api/ipo-current-issue?symbol=BLEL`
...
> Active candidate symbol: BLEL · Top-level keys: 0, 1, 2, 3, 4, 5, 6
...
[
  {
    ...
    "symbol": "BLEL",
    "category": "Total",
    "noOfSharesOffered": "7412769.0",
    "noOfTime": "1.3527015343389224",
    "noOfsharesBid": "1.0027264E7",
    "srNo": null
  },
  {
    ...
    "symbol": "SHIPROCKET",
    "category": "Total",
    "noOfSharesOffered": "9.443603E7",
    "noOfTime": "0.6980664689102242",
    "noOfsharesBid": "…[truncated, total 2730 chars]
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22095 chars] ; [bse:RELIANCE] BSE rows=26041, fields=1

```
{
  "CurrDate": "Wed Aug 12 2026 16:01:21",
  "PrevClose": "1321.2",
  "LowVal": "1310",
  "HighVal": "1330",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "250000",
  "Data": "[{\"dttm\":\"Wed Aug 12 2026 16:01:21\",\"vale1\":\"1327.10\",\"vole\":\"0\"},{\"dttm\":\"Wed Aug 12 2026 16:00:07\",\"vale1\":\"1327.10\",\"vole\":\"0\"},{\"dttm\":\"Wed Aug 12 2026 15:59:39\",\"vale1\":\"1327.10\",\"vole\":\"0\"},{\"dttm\":\"Wed Aug 12 2026 15:58:32\",\"vale1\":\"1327.10\",\"vole\":\"0\"},{\"dttm\":\"Wed Aug 12 2026 15:57:39\",\"vale1\":\"1327.10\",\"vole\":\"100000\"},{\"dttm\":\"Wed Aug 12 2026 15:56:26\",\"vale1\":\"1327.10\",\"vole\":\"0\"},{\"dttm\":\"Wed Aug 12 2026 15:55:43\",\"vale1\":\"1327.10\",\"vole\":\"50\"},{\"dttm\":\"Wed Aug…[truncated, total 30947 chars]
```
...
Reference&#32;&#35;18&#46;a6adc17&#46;1786535840&#46;dc47570
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;a6adc17&#46;1786535840&#46;dc47570</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 887629 chars]
```
...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="pingback" href="https://ipocentral.in/x…[truncated, total 506885 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=235272 | rendered_len=278490 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
<H1>Access Denied</H1>
 …[truncated, total 395 chars] ; [NSE IPO list] 8 IPOs; per-row keys: companyName, issueEndDate, issuePrice, issueSize, issueStartDate, series, status, symbol; sector fields: (none) ; [BSE IPO list] BSE HTML; sector-related words found: (none); bytes=13850
...
> mainboard: static status=200 bytes=149482 | sme: static status=200 bytes=149434 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=285508 | detail-2: static status=200 bytes=268285 | challenges_detected=false
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=235272 | rendered_len=277630 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (behari-lal-engineering-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> third_ipo_status=current | third_ipo_slug=behari-lal-engineering-ipo | third_ipo_reason="current-open: list "mainboard" row date range "12 - 14 Aug" covers today" | detail-1: static status=200 bytes=367848 | detail-2: static status=200 bytes=342024 | detail-3: static status=200 bytes=325802 | challenges_detected=false | robots_classification=allowed-prior-flag-was-over-match | robots_ipo_disallowed=false | robots: robots.txt: detail paths ALLOWED for *; the Phase 6A.1.1 flag was an OVER-MATCH (loose p.startsWith('/ipo') hit an unrelated rule). /ipo/onemi-technology-ipo/2576/→allowed (no matching rule); /ipo/bagmane-reit/3090/→allowed (no matching rule); /ipo/m-r-maniveni-ipo/2627/→allowed (no matching rule)

```
{
  "third_ipo": {
    "slug": "behari-lal-engineering-ipo",
    "url": "https://www.chittorgarh.com/ipo/behari-lal-engineering-ipo/2659/",
    "status": "current",
    "reason": "current-open: list \"mainboard\" row date range \"12 - 14 Aug\" covers today",
    "date_text": "12 - 14 Aug",
  ...
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "Behari Lal Engineering IPO Date, Price, GMP, Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.879 | avg_narrow=1.000 | pdf_on_allowlist=3 | pdf_off_allowlist=1 | third_ipo=behari-lal-engineering-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.82 narrow=1.00 | d3:behari-lal-engineering-ipo full=0.91 narrow=1.00
