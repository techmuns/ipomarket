...
Generated: 2026-05-28T21:22:20.641Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | YELLOW | 200 | JSON | 369 | Source reachable but 0 rows in current snapshot. category=ipo appears to be mainboard-only; if today's only IPOs are SME, P-05 should satisfy the IPO-list-source gate. |
| P-02 | NSE — Upcoming IPOs | YELLOW | 200 | JSON | 379 | Source reachable but 0 upcoming rows in current snapshot. category=ipo is mainboard-only; SME pipeline lives in P-05. |
| P-03 | NSE — Past/Recent IPOs | YELLOW | 200 | JSON | 52 | Source reachable but 0 rows in current snapshot. category=ipo is mainboard-only; recently-listed SMEs require P-05. |
| P-04 | NSE — Live Subscription | YELLOW | - | EMPTY | 21 | No currently open IPO discovered; re-run during an active issue window. Endpoint not validated this run. |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 905 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 12586 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | RED | 0 | ERROR | 63105 | Pipeline tab ships without status field; fallback = filing-date-only from P-08. |
| P-09 | SEBI — DRHP PDF Download | RED | 0 | ERROR | 60000 | Download failed; fall back to P-10 exchange-side DRHP archive. |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 10597 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 3734 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 22 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | RED | 200 | JSON | 327 | Maintain a manual override file for IPOs whose symbol drifts post-listing. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 467 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10011 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 533 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 23 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 533 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 116 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 5209 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 1163 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 3357 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 1438 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 2014 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 595 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 403 | BLOCKED | 95 | Skip. |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 369 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4194 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4545 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 2437 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 2071 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3722 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4180 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 3068 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
| P-26b | Chittorgarh — detail field extraction retune (Phase 6A.1) | GREEN | - | JSON | 24 | Precision met (full=0.85 narrow=0.93). Ready for Phase 6A.2 planning approval. |
...
- Latency: 369 ms
- Ran at (UTC): 2026-05-28T21:18:56.305Z
...
- Response type: ERROR
- Fields found: (none)
- Fields missing: tbody data rows
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Low
- Update frequency: Updated on filing/observation status changes
- Recommended action: Pipeline tab ships without status field; fallback = filing-date-only from P-08.
- Fallback: P-08
- Latency: 63105 ms
- Ran at (UTC): 2026-05-28T21:18:56.305Z

> static non-200 (status=0, err=This operation was aborted) ; playwright failed: page.goto: Timeout 35000ms exceeded.
Call log:
  - navigating to "https://www.sebi.gov.in/sebiweb/home/HomeAction.do?doListing=yes&sid=3&ssid=14&smid=8", waiting until "networkidle"
...
```
{
  ...
  "tbody_row_count": 0,
  "notes": "static non-200 (status=0, err=This operation was aborted)"
}
```

### P-09 — SEBI — DRHP PDF Download — RED
...
- Response type: ERROR
- Fields found: (none)
- Fields missing: downloadable pdf
- Parsing difficulty: Easy
- Anti-bot risk: Low
- Legal/ToS risk: Low
- Update frequency: Immutable once published
- Recommended action: Download failed; fall back to P-10 exchange-side DRHP archive.
- Fallback: P-10
- Latency: 60000 ms
- Ran at (UTC): 2026-05-28T21:18:56.305Z

> Sample URL: https://www.sebi.gov.in/sebi_data/commondocs/may-2026/Incred%20Holdings%20Limited-Abridged%20prospectus_p.pdf; status=0 bytes=0

```
download failed: status=0 bytes=0 err=This operation was aborted
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22095 chars] ; [bse:RELIANCE] BSE rows=27096, fields=1

```
{
  "CurrDate": "Wed May 27 2026 16:01:25",
  "PrevClose": "1356.9",
  "LowVal": "1345",
  "HighVal": "1365",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "200000",
  "Data": "[{\"dttm\":\"Wed May 27 2026 16:01:25\",\"vale1\":\"1350.00\",\"vole\":\"0\"},{\"dttm\":\"Wed May 27 2026 16:00:03\",\"vale1\":\"1350.00\",\"vole\":\"0\"},{\"dttm\":\"Wed May 27 2026 15:59:51\",\"vale1\":\"1350.00\",\"vole\":\"0\"},{\"dttm\":\"Wed May 27 2026 15:58:34\",\"vale1\":\"1350.00\",\"vole\":\"0\"},{\"dttm\":\"Wed May 27 2026 15:57:50\",\"vale1\":\"1350.00\",\"vole\":\"0\"},{\"dttm\":\"Wed May 27 2026 15:56:52\",\"vale1\":\"1350.00\",\"vole\":\"0\"},{\"dttm\":\"Wed May 27 2026 15:55:47\",\"vale1\":\"1350.00\",\"vole\":\"64000\"},{\"dttm\":\"Wed May 2…[truncated, total 32158 chars]
```
...
Reference&#32;&#35;18&#46;9d721102&#46;1780003289&#46;10bc38fc
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;9d721102&#46;1780003289&#46;10bc38fc</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 817938 chars]
```
...
```
<!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=Edge"><meta name="robots" content="noindex,nofollow"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="content-security-policy" content="default-src &#39;none&#39;; script-src &#39;nonce-Z21l4ZIr9BV5SCxyPLPlPb&#39; &#39;unsafe-eval&#39; https://challenges.cloudflare.com; script-s…[truncated, total 5747 chars]
```
...
> final_url=https://zerodha.com/ipo/440359/nfp-sampoorna-foods/ | title=NFP Sampoorna Foods IPO: Check IPO date, Price range & Lot size | render_mode=server-rendered | raw_len=37877 | rendered_len=38699 | challenge=false | headings=11 | tables=4 | doc_links=2 | labels=17
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=266325 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
<H1>Access Denied</H1>
 …[truncated, total 399 chars] ; [NSE IPO list] NSE IPO list returned 0 items ; [BSE IPO list] BSE HTML; sector-related words found: (none); bytes=12565
...
> mainboard: static status=200 bytes=146949 | sme: static status=200 bytes=149474 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=286322 | detail-2: static status=200 bytes=253878 | challenges_detected=false
...
```
{
  ...
  "picked_detail_urls": [
    "https://www.chittorgarh.com/ipo/hexagon-nutrition-ipo/2658/",
    "https://www.chittorgarh.com/ipo/cmr-green-technologies-ipo/2586/"
  ],
  "detail_titles": [
    "Hexagon Nutrition IPO Date, Price, GMP, Review, Details",
    "CMR Green Technologies IPO Date, Price, GMP, Details"
  ],
...
- Fields missing: d1.open_date[missing], d1.close_date[missing], d1.registrar[missing], d1.brlms[missing], d1.official_pdf_links[rejected-low], d2.issue_size_cr[rejected-low], d2.price_band[missing], d2.lot_size[missing], d2.open_date[missing], d2.close_date[missing], d2.registrar[missing], d2.brlms[missing], d2.official_pdf_links[rejected-low]
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> details_extracted=2 | avg_precision=0.350 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=2 | d1: main=86579b tables=9 rows=69 | d2: main=76968b tables=8 rows=50
...
```
{
  ...
  "details": [
    {
      "index": 1,
      "source_url": "https://www.chittorgarh.com/ipo/hexagon-nutrition-ipo/2658/",
      "found_count": 5,
      "precision_ratio": 0.5,
      "tables_parsed": 9,
    ...
    {
      "index": 2,
      "source_url": "https://www.chittorgarh.com/ipo/cmr-green-technologies-ipo/2586/",
      "found_count": 2,
      "precision_ratio": 0.2,
      "tables_parsed": 8,
      "table_rows_parsed": 50
    }
  ]
}
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=265859 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (rajnandini-fashion-india-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> third_ipo_status=current | third_ipo_slug=rajnandini-fashion-india-ipo | third_ipo_reason="current-open: list "sme" row date range "26 - 29 May" covers today" | detail-1: static status=200 bytes=343407 | detail-2: static status=200 bytes=318296 | detail-3: static status=200 bytes=301987 | challenges_detected=false | robots_classification=allowed-prior-flag-was-over-match | robots_ipo_disallowed=false | robots: robots.txt: detail paths ALLOWED for *; the Phase 6A.1.1 flag was an OVER-MATCH (loose p.startsWith('/ipo') hit an unrelated rule). /ipo/onemi-technology-ipo/2576/→allowed (no matching rule); /ipo/bagmane-reit/3090/→allowed (no matching rule); /ipo/m-r-maniveni-ipo/2627/→allowed (no matching rule)

```
{
  "third_ipo": {
    "slug": "rajnandini-fashion-india-ipo",
    "url": "https://www.chittorgarh.com/ipo/rajnandini-fashion-india-ipo/2729/",
    "status": "current",
    "reason": "current-open: list \"sme\" row date range \"26 - 29 May\" covers today",
    "date_text": "26 - 29 May",
    "source_list": "sme"
  },
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "Rajnandini Fashion India IPO Date, Price, GMP, Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.848 | avg_narrow=0.933 | pdf_on_allowlist=3 | pdf_off_allowlist=4 | third_ipo=rajnandini-fashion-india-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.73 narrow=0.80 | d3:rajnandini-fashion-india-ipo full=0.91 narrow=1.00
