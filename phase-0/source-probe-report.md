...
Generated: 2026-07-14T20:22:46.111Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 285 | Use as primary source for Live & Upcoming tab. |
| P-02 | NSE — Upcoming IPOs | GREEN | 200 | JSON | 58 | Use as primary for Upcoming/Pipeline tab. |
...
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 716 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2075 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 366 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2876 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11130 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 4782 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 21 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 21 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 1022 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10090 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 4565 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 35 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 401 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 173 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 5145 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 1242 | Store URL as link-out only. |
...
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1786 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1680 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 403 | BLOCKED | 39 | Skip. |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 270 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4335 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4806 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 599 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 89 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4599 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
...
- Fallback: P-06
- Latency: 285 ms
- Ran at (UTC): 2026-07-14T20:21:33.439Z
...
[
  {
    ...
    "noOfTime": "0.18562508316699933",
    "noOfsharesBid": "2231956.0",
    "srNo": null
  },
  {
    ...
    "noOfTime": "0.4531354504901017",
    "noOfsha…[truncated, total 846 chars]
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=26362, fields=1

```
{
  "CurrDate": "Tue Jul 14 2026 16:01:12",
  "PrevClose": "1296.85",
  "LowVal": "1290",
  "HighVal": "1310",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "100000",
  "Data": "[{\"dttm\":\"Tue Jul 14 2026 16:01:12\",\"vale1\":\"1291.00\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 14 2026 16:00:06\",\"vale1\":\"1291.00\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 14 2026 15:59:57\",\"vale1\":\"1291.00\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 14 2026 15:57:37\",\"vale1\":\"1291.00\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 14 2026 15:56:47\",\"vale1\":\"1291.00\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 14 2026 15:52:35\",\"vale1\":\"1291.00\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 14 2026 15:51:38\",\"vale1\":\"1291.00\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 14 2…[truncated, total 31329 chars]
```
...
Reference&#32;&#35;18&#46;ba7cb17&#46;1784060517&#46;34867741
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;ba7cb17&#46;1784060517&#46;34867741</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 827491 chars]
```
...
```
<!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=Edge"><meta name="robots" content="noindex,nofollow"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="content-security-policy" content="default-src &#39;none&#39;; script-src &#39;nonce-GrypEI7QOx9zojowXLlpL9&#39; &#39;unsafe-eval&#39; https://challenges.cloudflare.com; script-s…[truncated, total 5726 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=268124 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
<H1>Access Denied</H1>
 …[truncated, total 397 chars] ; [NSE IPO list] 3 IPOs; per-row keys: companyName, issueEndDate, issuePrice, issueSize, issueStartDate, series, status, symbol; sector fields: (none) ; [BSE IPO list] BSE HTML; sector-related words found: (none); bytes=12565
...
> mainboard: static status=200 bytes=148262 | sme: static status=200 bytes=147276 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=226587 | detail-2: static status=200 bytes=270521 | challenges_detected=false
...
- Response type: JSON
- Fields found: d1.company_name[high], d1.issue_size_cr[high], d1.listing_date[high], d1.official_pdf_links[high], d2.company_name[high], d2.issue_size_cr[high], d2.price_band[high], d2.lot_size[high], d2.listing_date[high]
- Fields missing: d1.price_band[missing], d1.lot_size[missing], d1.open_date[missing], d1.close_date[missing], d1.registrar[missing], d1.brlms[missing], d2.open_date[missing], d2.close_date[missing], d2.registrar[missing], d2.brlms[missing], d2.official_pdf_links[missing]
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> details_extracted=2 | avg_precision=0.450 | official_pdf_links_on_allowlist=1 | official_pdf_links_off_allowlist=0 | d1: main=69742b tables=5 rows=23 | d2: main=81858b tables=10 rows=54
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=268121 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
