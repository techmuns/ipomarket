...
Generated: 2026-07-28T20:24:57.850Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 517 | Use as primary source for Live & Upcoming tab. |
| P-02 | NSE — Upcoming IPOs | GREEN | 200 | JSON | 57 | Use as primary for Upcoming/Pipeline tab. |
| P-03 | NSE — Past/Recent IPOs | GREEN | 200 | JSON | 72 | Use as primary for Recently Listed. |
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 414 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 908 | Source reachable; 0 SME rows in current snapshot. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2570 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11393 | Skip if SEBI (P-08) is GREEN. |
...
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 820 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10045 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 433 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 79 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 574 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 208 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 2888 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 894 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 892 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 228 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 676 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 781 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 437 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 158 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4434 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4447 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1427 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 203 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3689 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4364 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 1328 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 517 ms
- Ran at (UTC): 2026-07-28T20:23:53.704Z
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=26174, fields=1

```
{
  "CurrDate": "Tue Jul 28 2026 16:01:30",
  "PrevClose": "1280.1",
  "LowVal": "1265",
  "HighVal": "1285",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "150000",
  "Data": "[{\"dttm\":\"Tue Jul 28 2026 16:01:30\",\"vale1\":\"1267.90\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 28 2026 16:00:04\",\"vale1\":\"1267.90\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 28 2026 15:59:25\",\"vale1\":\"1267.90\",\"vole\":\"6\"},{\"dttm\":\"Tue Jul 28 2026 15:52:54\",\"vale1\":\"1267.90\",\"vole\":\"15\"},{\"dttm\":\"Tue Jul 28 2026 15:48:31\",\"vale1\":\"1267.90\",\"vole\":\"20\"},{\"dttm\":\"Tue Jul 28 2026 15:45:01\",\"vale1\":\"1267.90\",\"vole\":\"20\"},{\"dttm\":\"Tue Jul 28 2026 15:44:38\",\"vale1\":\"1267.90\",\"vole\":\"10\"},{\"dttm\":\"Tue Jul 2…[truncated, total 31080 chars]
```
...
Reference&#32;&#35;18&#46;983b2f17&#46;1785270256&#46;82631e4
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;983b2f17&#46;1785270256&#46;82631e4</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 872834 chars]
```
...
> <tr> count: 20, bytes=313971

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP 2026 - IPO Grey Market Premium, Latest GMP &amp; Kostak - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-no-defer="1"…[truncated, total 313971 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=232933 | rendered_len=273005 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=148331 | sme: static status=200 bytes=149055 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=252311 | detail-2: static status=200 bytes=292078 | challenges_detected=false
...
- Response type: JSON
- Fields found: d1.company_name[high], d1.listing_date[high], d1.official_pdf_links[high], d2.company_name[high], d2.issue_size_cr[high], d2.price_band[high], d2.lot_size[high], d2.listing_date[high]
- Fields missing: d1.issue_size_cr[missing], d1.price_band[missing], d1.lot_size[missing], d1.open_date[missing], d1.close_date[missing], d1.registrar[missing], d1.brlms[missing], d2.open_date[missing], d2.close_date[missing], d2.registrar[missing], d2.brlms[missing], d2.official_pdf_links[rejected-low]
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> details_extracted=2 | avg_precision=0.400 | official_pdf_links_on_allowlist=1 | official_pdf_links_off_allowlist=1 | d1: main=75863b tables=10 rows=49 | d2: main=87898b tables=11 rows=68
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=232933 | rendered_len=272962 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (poojaa-precision-engg-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
```
{
  ...
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "Poojaa Precision Engg. IPO Date, Price, GMP, Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.848 | avg_narrow=1.000 | pdf_on_allowlist=2 | pdf_off_allowlist=1 | third_ipo=poojaa-precision-engg-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.82 narrow=1.00 | d3:poojaa-precision-engg-ipo full=0.82 narrow=1.00
