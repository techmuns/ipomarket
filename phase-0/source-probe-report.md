...
Generated: 2026-09-19T14:23:57.037Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 373 | Use as primary source for Live & Upcoming tab. |
...
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 388 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 966 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2569 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 327 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 3642 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11248 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 3971 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 71 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 300 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 752 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10090 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 694 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 249 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 1189 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 182 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 1003 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 818 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 899 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 230 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1403 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1703 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 200 | HTML | 415 | Skip. |
| P-22 | GMP — InvestorGain | RED | 200 | HTML | 165 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4151 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5394 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1769 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 1167 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3540 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4335 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 2743 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 373 ms
- Ran at (UTC): 2026-09-19T14:22:47.108Z
...
> Total rows: 7, Past/closed/listed rows: 3
...
[
  {
    ...
    "noOfTime": "0.6040483034227069",
    "noOfsharesBid": "5.35446E7",
    "srNo": null
  },
  {
    ...
    "noOfTime": "0.6866133866133867",
    "noOfs…[truncated, total 1791 chars]
```
...
> [static-primary] static ok: tr=0, bytes=6035 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=44586 (pdfs=14)
  ...
  "first_3_pdfs": [
    {
      ...
      "link_text": "Madhur Iron & Steel India Limited- Abridged Prospectus",
      "source": "static-alt"
    },
    {
...
> discovery=sebi-publicissues-pdfs.json; pdf_url=0Iron%20And%20Steel%20India%20Limited%20-%20Draft%20AP_p.pdf; bytes=790130; page_count=15; pdf-parse=ok
...
```
{
  ...
  "link_text": "Madhur Iron & Steel India Limited- Abridged Prospectus",
  "bytes": 790130,
  "sha256": "f99e6dfdc1412bcc…",
  "magic": "%PDF",
  "page_count": 15,
  "cover_text_first_200": "MADHUR IRON & STEEL (INDIA) LIMITED\nCorporate Identity Number: U35105CT2012PLC000189\nREGISTERED OFFICE CONTACT PERSON EMAIL AND TELEPHONE WEBSITE\n21/A, Light Industrial Area, Bhilai, Durg – 490026, Ke"
}
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22094 chars] ; [bse:RELIANCE] BSE rows=26034, fields=1

```
{
  "CurrDate": "Fri Sep 18 2026 16:01:26",
  "PrevClose": "1240.8",
  "LowVal": "1230",
  "HighVal": "1250",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "150000",
  "Data": "[{\"dttm\":\"Fri Sep 18 2026 16:01:26\",\"vale1\":\"1233.95\",\"vole\":\"0\"},{\"dttm\":\"Fri Sep 18 2026 16:00:03\",\"vale1\":\"1233.95\",\"vole\":\"0\"},{\"dttm\":\"Fri Sep 18 2026 15:59:44\",\"vale1\":\"1233.95\",\"vole\":\"35\"},{\"dttm\":\"Fri Sep 18 2026 15:58:57\",\"vale1\":\"1233.95\",\"vole\":\"1043\"},{\"dttm\":\"Fri Sep 18 2026 15:57:50\",\"vale1\":\"1233.95\",\"vole\":\"3055\"},{\"dttm\":\"Fri Sep 18 2026 15:56:58\",\"vale1\":\"1233.95\",\"vole\":\"612\"},{\"dttm\":\"Fri Sep 18 2026 15:55:51\",\"vale1\":\"1233.95\",\"vole\":\"172\"},{\"dttm\":\"Fr…[truncated, total 30940 chars]
```
...
Reference&#32;&#35;18&#46;1634d517&#46;1789827791&#46;2c720ef
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;1634d517&#46;1789827791&#46;2c720ef</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 937182 chars]
```
...
> <tr> count: 0, bytes=561880

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP Today 2026 – Live Grey Market Premium &amp; Kostak Rates - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-cfasync="fa…[truncated, total 561880 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=347228 | rendered_len=390054 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=149397 | sme: static status=200 bytes=149904 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=294839 | detail-2: static status=200 bytes=321508 | challenges_detected=false
...
```
{
  ...
  "picked_detail_urls": [
    ...
    "https://www.chittorgarh.com/ipo/adroit-industries-ipo/3007/"
  ],
  "detail_titles": [
    "A-One Steels IPO Date, Price, GMP, Review, Details",
    "Adroit Industries IPO Date, Price, GMP, Review, Details"
  ],
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=2 | d1: main=88067b tables=13 rows=73 | d2: main=95647b tables=12 rows=82
...
```
{
  ...
  "details": [
    ...
    {
      "index": 2,
      "source_url": "https://www.chittorgarh.com/ipo/adroit-industries-ipo/3007/",
      "found_count": 5,
      "precision_ratio": 0.5,
      "tables_parsed": 12,
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=347228 | rendered_len=390978 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
