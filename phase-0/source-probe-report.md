...
Generated: 2026-07-04T20:17:36.128Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | YELLOW | 200 | JSON | 333 | Source reachable but 0 rows in current snapshot. category=ipo appears to be mainboard-only; if today's only IPOs are SME, P-05 should satisfy the IPO-list-source gate. |
| P-02 | NSE — Upcoming IPOs | YELLOW | 200 | JSON | 273 | Source reachable but 0 upcoming rows in current snapshot. category=ipo is mainboard-only; SME pipeline lives in P-05. |
...
| P-04 | NSE — Live Subscription | YELLOW | - | EMPTY | 34 | No currently open IPO discovered; re-run during an active issue window. Endpoint not validated this run. |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 898 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 1896 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 323 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2929 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11143 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 5531 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 37 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | RED | 200 | JSON | 359 | Maintain a manual override file for IPOs whose symbol drifts post-listing. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 600 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10155 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 311 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 395 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 807 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 181 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 5337 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 1104 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 840 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 208 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1273 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1162 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 403 | BLOCKED | 80 | Skip. |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 87 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4037 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4984 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1497 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 2330 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4389 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4503 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 1791 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Latency: 333 ms
- Ran at (UTC): 2026-07-04T20:16:22.177Z
...
> [static-primary] static ok: tr=0, bytes=6080 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=44840 (pdfs=16)
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22095 chars] ; [bse:RELIANCE] BSE rows=27018, fields=1

```
{
  "CurrDate": "Fri Jul 03 2026 16:01:32",
  "PrevClose": "1303.8",
  "LowVal": "1302",
  "HighVal": "1310",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "75000",
  "Data": "[{\"dttm\":\"Fri Jul 03 2026 16:01:32\",\"vale1\":\"1304.25\",\"vole\":\"0\"},{\"dttm\":\"Fri Jul 03 2026 16:00:02\",\"vale1\":\"1304.25\",\"vole\":\"0\"},{\"dttm\":\"Fri Jul 03 2026 15:59:50\",\"vale1\":\"1304.25\",\"vole\":\"72\"},{\"dttm\":\"Fri Jul 03 2026 15:58:47\",\"vale1\":\"1304.25\",\"vole\":\"0\"},{\"dttm\":\"Fri Jul 03 2026 15:57:45\",\"vale1\":\"1304.25\",\"vole\":\"0\"},{\"dttm\":\"Fri Jul 03 2026 15:56:48\",\"vale1\":\"1304.25\",\"vole\":\"0\"},{\"dttm\":\"Fri Jul 03 2026 15:55:04\",\"vale1\":\"1304.25\",\"vole\":\"0\"},{\"dttm\":\"Fri Jul 03 20…[truncated, total 32067 chars]
```
...
Reference&#32;&#35;18&#46;4e6adc17&#46;1783196206&#46;9c7e585
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;4e6adc17&#46;1783196206&#46;9c7e585</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 827316 chars]
```
...
```
<!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=Edge"><meta name="robots" content="noindex,nofollow"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="content-security-policy" content="default-src &#39;none&#39;; script-src &#39;nonce-TVE5X9y6lnc8eMeGHuj50N&#39; &#39;unsafe-eval&#39; https://challenges.cloudflare.com; script-s…[truncated, total 5747 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=267796 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=147718 | sme: static status=200 bytes=149090 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=232458 | detail-2: static status=200 bytes=259998 | challenges_detected=false
...
```
{
  ...
  "picked_detail_urls": [
    "https://www.chittorgarh.com/ipo/laser-power-infra-ipo/2654/",
    "https://www.chittorgarh.com/ipo/kusumgar-ipo/2670/"
  ],
  "detail_titles": [
    "Laser Power &amp; Infra IPO Date, Price, GMP, Review, Details",
...
> details_extracted=2 | avg_precision=0.400 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=1 | d1: main=71502b tables=7 rows=38 | d2: main=79492b tables=10 rows=57
...
```
{
  ...
  "details": [
    {
      "index": 1,
      "source_url": "https://www.chittorgarh.com/ipo/laser-power-infra-ipo/2654/",
      "found_count": 3,
      "precision_ratio": 0.3,
      "tables_parsed": 7,
      "table_rows_parsed": 38
    },
    {
      "index": 2,
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=267929 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (ic-electricals-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> third_ipo_status=current | third_ipo_slug=ic-electricals-ipo | third_ipo_reason="current-open: list "sme" row date range "03 - 07 Jul" covers today" | detail-1: static status=200 bytes=352955 | detail-2: static status=200 bytes=329465 | detail-3: static status=200 bytes=313935 | challenges_detected=false | robots_classification=allowed-prior-flag-was-over-match | robots_ipo_disallowed=false | robots: robots.txt: detail paths ALLOWED for *; the Phase 6A.1.1 flag was an OVER-MATCH (loose p.startsWith('/ipo') hit an unrelated rule). /ipo/onemi-technology-ipo/2576/→allowed (no matching rule); /ipo/bagmane-reit/3090/→allowed (no matching rule); /ipo/m-r-maniveni-ipo/2627/→allowed (no matching rule)

```
{
  "third_ipo": {
    "slug": "ic-electricals-ipo",
    "url": "https://www.chittorgarh.com/ipo/ic-electricals-ipo/2754/",
    "status": "current",
    "reason": "current-open: list \"sme\" row date range \"03 - 07 Jul\" covers today",
    "date_text": "03 - 07 Jul",
    "source_list": "sme"
  },
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "IC Electricals IPO Date, Price, GMP, Review, Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.818 | avg_narrow=0.933 | pdf_on_allowlist=2 | pdf_off_allowlist=1 | third_ipo=ic-electricals-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.73 narrow=0.80 | d3:ic-electricals-ipo full=0.82 narrow=1.00
