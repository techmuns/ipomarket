...
Generated: 2026-06-02T08:06:08.312Z
...
| P-02 | NSE — Upcoming IPOs | GREEN | 200 | JSON | 231 | Use as primary for Upcoming/Pipeline tab. |
| P-03 | NSE — Past/Recent IPOs | GREEN | 200 | JSON | 24 | Use as primary for Recently Listed. |
| P-04 | NSE — Live Subscription | YELLOW | - | EMPTY | 26 | No currently open IPO discovered; re-run during an active issue window. Endpoint not validated this run. |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 1153 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2746 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 410 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 3557 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11250 | Skip if SEBI (P-08) is GREEN. |
...
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 56 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 642 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10110 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 287 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 26 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 568 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 41 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 5262 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 1264 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 1344 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 263 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 2425 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 525 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 403 | BLOCKED | 34 | Skip. |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 121 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 5446 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5268 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1317 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 122 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
| P-26 | Chittorgarh — detail field extraction (Phase 5C.3 calibration) | RED | - | JSON | 32 | Extraction precision below the §Y.9.1 threshold. Per the Phase 5C.3 acceptance gate, recommend NO for Chittorgarh ingestion and keep it reference-only / manual. |
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3498 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4349 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 1466 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 370 ms
- Ran at (UTC): 2026-06-02T08:04:54.855Z
...
> [static-primary] static ok: tr=0, bytes=6080 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=45820 (pdfs=18)
...
> discovery=sebi-publicissues-pdfs.json; pdf_url=026/Arohan%20Financial%20Services%20Limited%20-%20DRHP_p.pdf; bytes=619670; page_count=15; pdf-parse=ok
...
```
{
  ...
  "link_text": "Arohan Financial Services Limited Draft Abridged Prospectus",
  "bytes": 619670,
  "sha256": "b1078625a764dc4c…",
  "magic": "%PDF",
  "page_count": 15,
  "cover_text_first_200": "AROHAN FINANCIAL SERVICES LIMITED\nCORPORATE IDENTITY NUMBER: U74140WB1991PLC053189\nREGISTERED AND CORPORATE OFFICE CONTACT E-MAIL AND TELEPHONE WEBSITE\nPERSON\nPTI Building, 4th Floor, DP 9, Sector 5, "
}
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22095 chars] ; [bse:RELIANCE] BSE rows=17639, fields=1

```
{
  "CurrDate": "Tue Jun 02 2026 13:34:59",
  "PrevClose": "1320.3",
  "LowVal": "1300",
  "HighVal": "1330",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "40000",
  "Data": "[{\"dttm\":\"Tue Jun 02 2026 13:34:59\",\"vale1\":\"1327.00\",\"vole\":\"3525\"},{\"dttm\":\"Tue Jun 02 2026 13:33:59\",\"vale1\":\"1326.95\",\"vole\":\"3891\"},{\"dttm\":\"Tue Jun 02 2026 13:32:59\",\"vale1\":\"1324.75\",\"vole\":\"3031\"},{\"dttm\":\"Tue Jun 02 2026 13:31:59\",\"vale1\":\"1322.90\",\"vole\":\"5795\"},{\"dttm\":\"Tue Jun 02 2026 13:30:59\",\"vale1\":\"1323.25\",\"vole\":\"1845\"},{\"dttm\":\"Tue Jun 02 2026 13:29:59\",\"vale1\":\"1323.35\",\"vole\":\"2727\"},{\"dttm\":\"Tue Jun 02 2026 13:28:59\",\"vale1\":\"1322.05\",\"vole\":\"1222\"},{\"dt…[truncated, total 20996 chars]
```
...
Reference&#32;&#35;18&#46;902d3e17&#46;1780387520&#46;34e47d13
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;902d3e17&#46;1780387520&#46;34e47d13</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 815282 chars]
```
...
```
<!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=Edge"><meta name="robots" content="noindex,nofollow"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="content-security-policy" content="default-src &#39;none&#39;; script-src &#39;nonce-SDfUXtZSIj34uzOe5e9sR6&#39; &#39;unsafe-eval&#39; https://challenges.cloudflare.com; script-s…[truncated, total 5747 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=267763 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=147015 | sme: static status=200 bytes=148026 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=295984 | detail-2: static status=200 bytes=282669 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=1 | d1: main=89422b tables=10 rows=73 | d2: main=85247b tables=11 rows=70
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=266483 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
