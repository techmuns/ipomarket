...
Generated: 2026-09-21T08:55:19.040Z
...
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 4631 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 545 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 3049 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 13373 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 5054 | NSE historical still blocked; use BSE historical as primary (official fallback). |
...
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 636 | Skip; NSE primary covers this. |
...
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 63 | Fall back to per-issue page scrape or manual seed. |
...
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 1020 | Store URL as link-out only. |
...
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 4653 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 12893 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 200 | HTML | 391 | Skip. |
| P-22 | GMP — InvestorGain | RED | 200 | HTML | 139 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4476 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5386 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 248 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 2557 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3856 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 5522 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | YELLOW | 200 | HTML | 121241 | Partial success — review chittorgarh-fields-v2.json before approving any next-slice work. |
| P-26b | Chittorgarh — detail field extraction retune (Phase 6A.1) | GREEN | - | JSON | 40 | Precision met (full=0.85 narrow=1.00). Ready for Phase 6A.2 planning approval. |
...
- Fallback: P-06
- Latency: 348 ms
- Ran at (UTC): 2026-09-21T08:51:50.946Z
...
[
  {
    ...
    "noOfTime": "2.6313588911808186",
    "noOfsharesBid": "2.33251312E8",
    "srNo": null
  },
  {
    ...
    "noOfTime": "1.1127422577422577",
    "no…[truncated, total 1797 chars]
```
...
> [static-primary] static ok: tr=0, bytes=6035 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=44973 (pdfs=15)
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22095 chars] ; [bse:RELIANCE] BSE rows=20680, fields=1

```
{
  "CurrDate": "Mon Sep 21 2026 14:21:59",
  "PrevClose": "1233.95",
  "LowVal": "1230",
  "HighVal": "1245",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "100000",
  "Data": "[{\"dttm\":\"Mon Sep 21 2026 14:21:59\",\"vale1\":\"1243.80\",\"vole\":\"151\"},{\"dttm\":\"Mon Sep 21 2026 14:20:59\",\"vale1\":\"1244.10\",\"vole\":\"67\"},{\"dttm\":\"Mon Sep 21 2026 14:19:59\",\"vale1\":\"1244.10\",\"vole\":\"436\"},{\"dttm\":\"Mon Sep 21 2026 14:18:59\",\"vale1\":\"1243.70\",\"vole\":\"127\"},{\"dttm\":\"Mon Sep 21 2026 14:17:59\",\"vale1\":\"1244.00\",\"vole\":\"380\"},{\"dttm\":\"Mon Sep 21 2026 14:16:59\",\"vale1\":\"1243.50\",\"vole\":\"343\"},{\"dttm\":\"Mon Sep 21 2026 14:15:59\",\"vale1\":\"1243.60\",\"vole\":\"179\"},{\"dttm\":\…[truncated, total 24603 chars]
```
...
Reference&#32;&#35;18&#46;d11c2117&#46;1789980739&#46;bb34c7e
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;d11c2117&#46;1789980739&#46;bb34c7e</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 955490 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=347228 | rendered_len=391970 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=149379 | sme: static status=200 bytes=149553 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=289050 | detail-2: static status=200 bytes=294839 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=2 | d1: main=86186b tables=12 rows=71 | d2: main=88067b tables=13 rows=73
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=347228 | rendered_len=391840 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-3 reachable (static), third IPO selection: current (robokidz-eduventures-ipo)
