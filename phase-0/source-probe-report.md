...
Generated: 2026-08-17T04:01:31.737Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 667 | Use as primary source for Live & Upcoming tab. |
| P-02 | NSE — Upcoming IPOs | GREEN | 200 | JSON | 94 | Use as primary for Upcoming/Pipeline tab. |
| P-03 | NSE — Past/Recent IPOs | GREEN | 200 | JSON | 94 | Use as primary for Recently Listed. |
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 440 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 1143 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 3697 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 443 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 4195 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11292 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 3247 | NSE historical still blocked; use BSE historical as primary (official fallback). |
...
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 716 | Store URL as link-out; do not scrape per-PAN. |
...
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 857 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 1386 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 248 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | RED | 0 | ERROR | 10486 | Skip; phase-6 feature flag stays off if all GMP probes fail. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 758 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 458 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 393 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | RED | - | ERROR | 30074 | Blocked from GH Actions runner. Use screenshots/PDF exports as IA reference. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5654 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1489 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 2056 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3701 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4713 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 2202 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 667 ms
- Ran at (UTC): 2026-08-17T03:59:45.203Z
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=1016, fields=1

```
{
  "CurrDate": "Mon Aug 17 2026 09:29:59",
  "PrevClose": "1308",
  "LowVal": "1305",
  "HighVal": "1310",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "50000",
  "Data": "[{\"dttm\":\"Mon Aug 17 2026 09:29:59\",\"vale1\":\"1306.70\",\"vole\":\"151\"},{\"dttm\":\"Mon Aug 17 2026 09:28:59\",\"vale1\":\"1306.50\",\"vole\":\"288\"},{\"dttm\":\"Mon Aug 17 2026 09:27:59\",\"vale1\":\"1306.45\",\"vole\":\"2452\"},{\"dttm\":\"Mon Aug 17 2026 09:26:59\",\"vale1\":\"1307.30\",\"vole\":\"1916\"},{\"dttm\":\"Mon Aug 17 2026 09:25:59\",\"vale1\":\"1306.50\",\"vole\":\"1761\"},{\"dttm\":\"Mon Aug 17 2026 09:24:59\",\"vale1\":\"1306.15\",\"vole\":\"1335\"},{\"dttm\":\"Mon Aug 17 2026 09:23:59\",\"vale1\":\"1308.00\",\"vole\":\"722\"},{\"dttm\":…[truncated, total 1431 chars]
```
...
Reference&#32;&#35;18&#46;873b2f17&#46;1786939211&#46;14f42ecc
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;873b2f17&#46;1786939211&#46;14f42ecc</P>
</BODY>
</HTML>
...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="pingback" href="https://ipocentral.in/x…[truncated, total 499093 chars]
```
...
> final_url=https://zerodha.com/ipo/440359/nfp-sampoorna-foods/ | title= | render_mode=unknown | raw_len=0 | rendered_len=0 | challenge=false | headings=0 | tables=0 | doc_links=0 | labels=0 | error=page.goto: Timeout 30000ms exceeded.
Call log:
  - navigating to "https://zerodha.com/ipo/440359/nfp-sampoorna-foods/", waiting until "networkidle"
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=235304 | rendered_len=277918 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=149405 | sme: static status=200 bytes=149752 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=301460 | detail-2: static status=200 bytes=278054 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=2 | d1: main=88489b tables=11 rows=72 | d2: main=84816b tables=12 rows=72
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=235304 | rendered_len=277884 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (horizon-industrial-parks-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
```
{
  ...
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "Horizon Industrial Parks IPO Date, Price, GMP, Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.848 | avg_narrow=1.000 | pdf_on_allowlist=2 | pdf_off_allowlist=1 | third_ipo=horizon-industrial-parks-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.82 narrow=1.00 | d3:horizon-industrial-parks-ipo full=0.82 narrow=1.00
