...
Generated: 2026-07-15T12:41:56.926Z
...
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 333 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 1173 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 1952 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 305 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2636 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11201 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 3638 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 33 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 249 | Deterministic mapping; no manual override file needed for v1. |
...
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 449 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 457 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 190 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 4905 | Store URL as link-out only. |
...
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 758 | Include in Phase 6 GMP averager. |
...
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 403 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4246 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4670 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1597 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 127 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3908 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4534 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
...
- Fallback: P-06
- Latency: 357 ms
- Ran at (UTC): 2026-07-15T12:40:50.278Z
...
[
  {
    ...
    "noOfTime": "0.5131320691949435",
    "noOfsharesBid": "6169900.0",
    "srNo": null
  },
  {
...
> [static-primary] static ok: tr=0, bytes=6080 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=46213 (pdfs=20)
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22094 chars] ; [bse:RELIANCE] BSE rows=26469, fields=1

```
{
  "CurrDate": "Wed Jul 15 2026 16:01:12",
  "PrevClose": "1291",
  "LowVal": "1290",
  "HighVal": "1310",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "20000",
  "Data": "[{\"dttm\":\"Wed Jul 15 2026 16:01:12\",\"vale1\":\"1295.40\",\"vole\":\"0\"},{\"dttm\":\"Wed Jul 15 2026 16:00:02\",\"vale1\":\"1295.40\",\"vole\":\"0\"},{\"dttm\":\"Wed Jul 15 2026 15:59:35\",\"vale1\":\"1295.40\",\"vole\":\"0\"},{\"dttm\":\"Wed Jul 15 2026 15:58:25\",\"vale1\":\"1295.40\",\"vole\":\"0\"},{\"dttm\":\"Wed Jul 15 2026 15:57:56\",\"vale1\":\"1295.40\",\"vole\":\"0\"},{\"dttm\":\"Wed Jul 15 2026 15:52:19\",\"vale1\":\"1295.40\",\"vole\":\"0\"},{\"dttm\":\"Wed Jul 15 2026 15:51:55\",\"vale1\":\"1295.40\",\"vole\":\"0\"},{\"dttm\":\"Wed Jul 15 2026 …[truncated, total 31456 chars]
```
...
Reference&#32;&#35;18&#46;264e4e68&#46;1784119273&#46;dea1aa9
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;264e4e68&#46;1784119273&#46;dea1aa9</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 829364 chars]
```
...
```
<!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=Edge"><meta name="robots" content="noindex,nofollow"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="content-security-policy" content="default-src &#39;none&#39;; script-src &#39;nonce-B61Z8nFHb6pt6IQlwZdOXF&#39; &#39;unsafe-eval&#39; https://challenges.cloudflare.com; script-s…[truncated, total 5726 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=267483 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=148294 | sme: static status=200 bytes=146108 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=232529 | detail-2: static status=200 bytes=271539 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.450 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=1 | d1: main=71229b tables=5 rows=26 | d2: main=82130b tables=10 rows=54
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=267214 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (sbi-funds-management-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> third_ipo_status=current | third_ipo_slug=sbi-funds-management-ipo | third_ipo_reason="current-open: list "mainboard" row date range "14 - 16 Jul" covers today" | detail-1: static status=200 bytes=352707 | detail-2: static status=200 bytes=329493 | detail-3: static status=200 bytes=425231 | challenges_detected=false | robots_classification=allowed-prior-flag-was-over-match | robots_ipo_disallowed=false | robots: robots.txt: detail paths ALLOWED for *; the Phase 6A.1.1 flag was an OVER-MATCH (loose p.startsWith('/ipo') hit an unrelated rule). /ipo/onemi-technology-ipo/2576/→allowed (no matching rule); /ipo/bagmane-reit/3090/→allowed (no matching rule); /ipo/m-r-maniveni-ipo/2627/→allowed (no matching rule)

```
{
  "third_ipo": {
    "slug": "sbi-funds-management-ipo",
    "url": "https://www.chittorgarh.com/ipo/sbi-funds-management-ipo/2949/",
    "status": "current",
    "reason": "current-open: list \"mainboard\" row date range \"14 - 16 Jul\" covers today",
    "date_text": "14 - 16 Jul",
  ...
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "SBI Funds Management IPO Date, Price, GMP, Review, Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.818 | avg_narrow=0.933 | pdf_on_allowlist=2 | pdf_off_allowlist=1 | third_ipo=sbi-funds-management-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.73 narrow=0.80 | d3:sbi-funds-management-ipo full=0.82 narrow=1.00
