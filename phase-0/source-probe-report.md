...
Generated: 2026-07-21T06:06:15.928Z
...
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 885 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2052 | Use as primary for Pipeline tab + DRHP master. |
...
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 2867 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 24 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 504 | Deterministic mapping; no manual override file needed for v1. |
...
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 110 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 284 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 1531 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 150 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 4552 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 1140 | Store URL as link-out only. |
...
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 545 | Skip; Phase 6 stays off if all GMP probes fail. |
...
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4698 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4169 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 973 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 1927 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3473 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
...
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 83 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 377 ms
- Ran at (UTC): 2026-07-21T06:05:08.221Z
...
[
  {
    ...
    "noOfTime": "30.38664806151136",
    "noOfsharesBid": "2.38104335E8",
    "srNo": null
  },
  {
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=9435, fields=1

```
{
  "CurrDate": "Tue Jul 21 2026 11:34:59",
  "PrevClose": "1323.25",
  "LowVal": "1310",
  "HighVal": "1325",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "30000",
  "Data": "[{\"dttm\":\"Tue Jul 21 2026 11:34:59\",\"vale1\":\"1313.90\",\"vole\":\"315\"},{\"dttm\":\"Tue Jul 21 2026 11:33:59\",\"vale1\":\"1313.80\",\"vole\":\"545\"},{\"dttm\":\"Tue Jul 21 2026 11:32:59\",\"vale1\":\"1313.00\",\"vole\":\"136\"},{\"dttm\":\"Tue Jul 21 2026 11:31:59\",\"vale1\":\"1313.10\",\"vole\":\"1010\"},{\"dttm\":\"Tue Jul 21 2026 11:30:59\",\"vale1\":\"1312.90\",\"vole\":\"281\"},{\"dttm\":\"Tue Jul 21 2026 11:29:59\",\"vale1\":\"1312.65\",\"vole\":\"2151\"},{\"dttm\":\"Tue Jul 21 2026 11:28:59\",\"vale1\":\"1312.00\",\"vole\":\"988\"},{\"dttm\"…[truncated, total 11353 chars]
```
...
Reference&#32;&#35;18&#46;65c83017&#46;1784613930&#46;a8dab497
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;65c83017&#46;1784613930&#46;a8dab497</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 831895 chars]
```
...
> <tr> count: 16, bytes=311529

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP 2026 - IPO Grey Market Premium, Latest GMP &amp; Kostak - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-no-defer="1"…[truncated, total 311529 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=265834 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=146452 | sme: static status=200 bytes=147848 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=295040 | detail-2: static status=200 bytes=308771 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=1 | d1: main=88165b tables=10 rows=65 | d2: main=92176b tables=10 rows=74
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=267160 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
