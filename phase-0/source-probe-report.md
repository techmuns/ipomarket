...
Generated: 2026-09-09T21:41:37.541Z
...
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 490 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 957 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 1713 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2586 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 12495 | Skip if SEBI (P-08) is GREEN. |
...
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 299 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 757 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10162 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 382 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 330 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 1323 | Store URL as link-out; do not scrape per-PAN. |
...
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1530 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1505 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 200 | HTML | 880 | Skip. |
...
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5024 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 884 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 148 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4302 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
...
- Fallback: P-06
- Latency: 306 ms
- Ran at (UTC): 2026-09-09T21:40:33.212Z
...
> Total rows: 12, Past/closed/listed rows: 1
...
[
  ...
  },
  {
    ...
    "noOfTime": "1.1230474709065168",
    "noOfsharesBid": "2.350233E7",
    "s…[truncated, total 4534 chars]
```
...
> [static-primary] static ok: tr=0, bytes=6035 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=45403 (pdfs=16)
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22094 chars] ; [bse:RELIANCE] BSE rows=26343, fields=1

```
{
  "CurrDate": "Wed Sep 09 2026 16:01:24",
  "PrevClose": "1294.3",
  "LowVal": "1275",
  "HighVal": "1295",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "250000",
  "Data": "[{\"dttm\":\"Wed Sep 09 2026 16:01:24\",\"vale1\":\"1281.00\",\"vole\":\"0\"},{\"dttm\":\"Wed Sep 09 2026 16:00:06\",\"vale1\":\"1281.00\",\"vole\":\"0\"},{\"dttm\":\"Wed Sep 09 2026 15:59:20\",\"vale1\":\"1281.00\",\"vole\":\"16\"},{\"dttm\":\"Wed Sep 09 2026 15:58:51\",\"vale1\":\"1281.00\",\"vole\":\"8\"},{\"dttm\":\"Wed Sep 09 2026 15:57:00\",\"vale1\":\"1281.00\",\"vole\":\"0\"},{\"dttm\":\"Wed Sep 09 2026 15:56:49\",\"vale1\":\"1281.00\",\"vole\":\"6\"},{\"dttm\":\"Wed Sep 09 2026 15:55:31\",\"vale1\":\"1281.00\",\"vole\":\"1\"},{\"dttm\":\"Wed Sep 09 2…[truncated, total 31297 chars]
```
...
Reference&#32;&#35;18&#46;1634d517&#46;1788990056&#46;da5fefc
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;1634d517&#46;1788990056&#46;da5fefc</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 895984 chars]
```
...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="pingback" href="https://ipocentral.in/x…[truncated, total 534617 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=346702 | rendered_len=391524 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=150015 | sme: static status=200 bytes=150138 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=254094 | detail-2: static status=200 bytes=280710 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.200 | official_pdf_links_on_allowlist=1 | official_pdf_links_off_allowlist=0 | d1: main=76369b tables=9 rows=66 | d2: main=84116b tables=10 rows=60
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=346702 | rendered_len=391542 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
