...
Generated: 2026-09-07T22:01:18.395Z
...
| P-02 | NSE — Upcoming IPOs | GREEN | 200 | JSON | 45 | Use as primary for Upcoming/Pipeline tab. |
...
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 998 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2605 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 422 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2692 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 13136 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 3395 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 100 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 280 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 1508 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10490 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 1176 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 87 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 1070 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 150 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 1035 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 844 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 903 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 222 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1439 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 737 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 200 | HTML | 169 | Skip. |
| P-22 | GMP — InvestorGain | RED | 200 | HTML | 231 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 5351 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4319 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 3697 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 1206 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4115 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4305 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 1444 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 321 ms
- Ran at (UTC): 2026-09-07T22:00:06.447Z

> Total rows: 11, Active rows: 4

```
{
  "companyName": "Prasol Chemicals Limited",
  "issueEndDate": "10-Sep-2026",
  "issuePrice": "Rs.643 to Rs.676",
  "issueSize": "5443229",
  "issueStartDate": "08-Sep-2026",
  "series": "EQ",
  "status": "Active",
  "symbol": "PRASOLCHEM"
}
...
> Total rows: 11, Forthcoming/upcoming rows: 7
...
> Total rows: 11, Past/closed/listed rows: 0
...
- URL: `https://www.nseindia.com/api/ipo-current-issue?symbol=PRASOLCHEM`
...
> Active candidate symbol: PRASOLCHEM · Top-level keys: 0, 1, 2, 3, 4
...
> [static-primary] static ok: tr=0, bytes=6080 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=45785 (pdfs=17)
...
```
{
  ...
  "first_3_pdfs": [
    ...
    {
      "url": "https://www.sebi.gov.in/sebi_data/commondocs/sep-2026/Sembcorp%20Green%20Infra%20Limited%20-%20Draft%20Abridged%20Prospectus_p.pdf",
      "link_text": "Sembcorp Green Infra Limited - Draft Abridged Prospectus",
      "source": "static-alt"
    }
  ],
...
> discovery=sebi-publicissues-pdfs.json; pdf_url=0Coalfields%20Limited%20_Draft%20Abridged%20Prospectus_p.pdf; bytes=571534; page_count=14; pdf-parse=ok
...
```
{
  ...
  "link_text": "Mahanadi Coalfields Ltd. - Draft Abridged Prospectus",
  "bytes": 571534,
  "sha256": "d65e92dd906a405c…",
  "magic": "%PDF",
  "page_count": 14,
  "cover_text_first_200": "MAHANADI COALFIELDS LIMITED\nCORPORATE IDENTITY NUMBER: U10102OR1992GOI003038\nREGISTERED AND CORPORATE CONTACT PERSON TELEPHONE AND E-MAIL WEBSITE\nOFFICE\nJagruti Vihar, Burla, Sambalpur 768020, Soubhag"
}
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=25916, fields=1

```
{
  "CurrDate": "Mon Sep 07 2026 16:01:32",
  "PrevClose": "1322",
  "LowVal": "1300",
  "HighVal": "1325",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "50000",
  "Data": "[{\"dttm\":\"Mon Sep 07 2026 16:01:32\",\"vale1\":\"1309.50\",\"vole\":\"0\"},{\"dttm\":\"Mon Sep 07 2026 16:00:04\",\"vale1\":\"1309.50\",\"vole\":\"0\"},{\"dttm\":\"Mon Sep 07 2026 15:59:50\",\"vale1\":\"1309.50\",\"vole\":\"0\"},{\"dttm\":\"Mon Sep 07 2026 15:58:36\",\"vale1\":\"1309.50\",\"vole\":\"0\"},{\"dttm\":\"Mon Sep 07 2026 15:57:51\",\"vale1\":\"1309.50\",\"vole\":\"14\"},{\"dttm\":\"Mon Sep 07 2026 15:56:50\",\"vale1\":\"1309.50\",\"vole\":\"1\"},{\"dttm\":\"Mon Sep 07 2026 15:55:12\",\"vale1\":\"1309.50\",\"vole\":\"0\"},{\"dttm\":\"Mon Sep 07 2026…[truncated, total 30783 chars]
```
...
Reference&#32;&#35;18&#46;983b2f17&#46;1788818431&#46;3f5cd31
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;983b2f17&#46;1788818431&#46;3f5cd31</P>
</BODY>
</HTML>
...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="/assets/index-CErx_-cl.js"></script>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 909684 chars]
```
...
> <tr> count: 0, bytes=574443

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP Today 2026 – Live Grey Market Premium &amp; Kostak Rates - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-cfasync="fa…[truncated, total 574443 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=350987 | rendered_len=394112 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
<H1>Access Denied</H1>
 …[truncated, total 397 chars] ; [NSE IPO list] 11 IPOs; per-row keys: companyName, issueEndDate, issuePrice, issueSize, issueStartDate, series, status, symbol; sector fields: (none) ; [BSE IPO list] BSE HTML; sector-related words found: (none); bytes=14287
...
> mainboard: static status=200 bytes=149603 | sme: static status=200 bytes=148450 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=250305 | detail-2: static status=200 bytes=285030 | challenges_detected=false
...
```
{
  ...
  "picked_detail_urls": [
    ...
    "https://www.chittorgarh.com/ipo/manika-plastech-ipo/2483/"
  ],
  "detail_titles": [
    "NSE IPO Date, Price, GMP, Review, Analysis &amp; Details",
    "Manika Plastech IPO Date, Price, GMP, Review, Details"
  ],
...
> details_extracted=2 | avg_precision=0.350 | official_pdf_links_on_allowlist=1 | official_pdf_links_off_allowlist=1 | d1: main=75005b tables=8 rows=63 | d2: main=85698b tables=11 rows=63
...
```
{
  ...
  "details": [
    ...
    {
      "index": 2,
      "source_url": "https://www.chittorgarh.com/ipo/manika-plastech-ipo/2483/",
      "found_count": 5,
      "precision_ratio": 0.5,
      "tables_parsed": 11,
      "table_rows_parsed": 63
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=350987 | rendered_len=396238 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (pranav-constructions-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> third_ipo_status=current | third_ipo_slug=pranav-constructions-ipo | third_ipo_reason="current-open: list "mainboard" row date range "07 - 09 Sep" covers today" | detail-1: static status=200 bytes=366663 | detail-2: static status=200 bytes=341176 | detail-3: static status=200 bytes=306980 | challenges_detected=false | robots_classification=allowed-prior-flag-was-over-match | robots_ipo_disallowed=false | robots: robots.txt: detail paths ALLOWED for *; the Phase 6A.1.1 flag was an OVER-MATCH (loose p.startsWith('/ipo') hit an unrelated rule). /ipo/onemi-technology-ipo/2576/→allowed (no matching rule); /ipo/bagmane-reit/3090/→allowed (no matching rule); /ipo/m-r-maniveni-ipo/2627/→allowed (no matching rule)

```
{
  "third_ipo": {
    "slug": "pranav-constructions-ipo",
    "url": "https://www.chittorgarh.com/ipo/pranav-constructions-ipo/2127/",
    "status": "current",
    "reason": "current-open: list \"mainboard\" row date range \"07 - 09 Sep\" covers today",
    "date_text": "07 - 09 Sep",
  ...
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "Pranav Constructions IPO Date, Price, GMP, Review, Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.848 | avg_narrow=1.000 | pdf_on_allowlist=2 | pdf_off_allowlist=1 | third_ipo=pranav-constructions-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.82 narrow=1.00 | d3:pranav-constructions-ipo full=0.82 narrow=1.00
