...
Generated: 2026-08-17T11:38:14.279Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 372 | Use as primary source for Live & Upcoming tab. |
...
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 446 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 917 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2875 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 3824 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11730 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 4712 | NSE historical still blocked; use BSE historical as primary (official fallback). |
...
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 797 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10051 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 376 | Rely on NSE only (P-04). |
...
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 1114 | Store URL as link-out only. |
...
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 536 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 777 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 421 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 149 | Include in Phase 6 GMP averager. |
...
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 2677 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4084 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4555 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 3484 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 372 ms
- Ran at (UTC): 2026-08-17T11:37:03.601Z
...
- URL: `https://www.nseindia.com/api/ipo-current-issue?symbol=LALITHAA`
...
> Active candidate symbol: LALITHAA · Top-level keys: 0, 1, 2, 3, 4
...
[
  {
    ...
    "symbol": "LALITHAA",
    "category": "Total",
    "noOfSharesOffered": "6.2761403E7",
    "noOfTime": "0.3930637433328251",
    "noOfsharesBid": "2.4669232E7",
    "srNo": null
  },
  {
    ...
    "symbol": "HORIZONIND",
    "category": "Total",
    "noOfSharesOffered": "2.51356273E8",
    "noOfTime": "0.0327712131536896…[truncated, total 1805 chars]
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22098 chars] ; [bse:RELIANCE] BSE rows=25975, fields=1

```
{
  "CurrDate": "Mon Aug 17 2026 16:01:30",
  "PrevClose": "1308",
  "LowVal": "1295",
  "HighVal": "1325",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "50000",
  "Data": "[{\"dttm\":\"Mon Aug 17 2026 16:01:30\",\"vale1\":\"1318.40\",\"vole\":\"0\"},{\"dttm\":\"Mon Aug 17 2026 16:00:07\",\"vale1\":\"1318.40\",\"vole\":\"0\"},{\"dttm\":\"Mon Aug 17 2026 15:59:24\",\"vale1\":\"1318.40\",\"vole\":\"0\"},{\"dttm\":\"Mon Aug 17 2026 15:58:20\",\"vale1\":\"1318.40\",\"vole\":\"0\"},{\"dttm\":\"Mon Aug 17 2026 15:57:42\",\"vale1\":\"1318.40\",\"vole\":\"1\"},{\"dttm\":\"Mon Aug 17 2026 15:56:12\",\"vale1\":\"1318.40\",\"vole\":\"0\"},{\"dttm\":\"Mon Aug 17 2026 15:55:30\",\"vale1\":\"1318.40\",\"vole\":\"0\"},{\"dttm\":\"Mon Aug 17 2026 …[truncated, total 30866 chars]
```
...
Reference&#32;&#35;18&#46;e9b219b8&#46;1786966649&#46;915102e2
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;e9b219b8&#46;1786966649&#46;915102e2</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 888532 chars]
```
...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="pingback" href="https://ipocentral.in/x…[truncated, total 500080 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=235304 | rendered_len=280399 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=149405 | sme: static status=200 bytes=149684 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=301460 | detail-2: static status=200 bytes=278054 | challenges_detected=false
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=235304 | rendered_len=279705 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> details_extracted=3 | avg_full=0.848 | avg_narrow=1.000 | pdf_on_allowlist=2 | pdf_off_allowlist=2 | third_ipo=horizon-industrial-parks-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.82 narrow=1.00 | d3:horizon-industrial-parks-ipo full=0.82 narrow=1.00
