...
Generated: 2026-08-07T05:02:44.632Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 279 | Use as primary source for Live & Upcoming tab. |
...
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 477 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 910 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2074 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2836 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11280 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 3869 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 24 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 240 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 650 | Skip; NSE primary covers this. |
...
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 488 | Store URL as link-out; do not scrape per-PAN. |
...
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 832 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 215 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | RED | 0 | ERROR | 10257 | Skip; phase-6 feature flag stays off if all GMP probes fail. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 523 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 96 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 58 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4014 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5078 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
...
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 1301 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3501 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 5341 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
...
- Fallback: P-06
- Latency: 279 ms
- Ran at (UTC): 2026-08-07T05:01:30.187Z
...
> Active candidate symbol: LEAP · Top-level keys: 0, 1, 2, 3
...
[
  {
    ...
    "noOfTime": "0.0068543187038616294",
    "noOfsharesBid": "788190.0",
    "srNo": null
  },
  {
    ...
    "noOfTime": "0.06224698485906899",
    "noOfsharesBid…[truncated, total 1576 chars]
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=5143, fields=1

```
{
  "CurrDate": "Fri Aug 07 2026 10:30:59",
  "PrevClose": "1325",
  "LowVal": "1315",
  "HighVal": "1335",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "100000",
  "Data": "[{\"dttm\":\"Fri Aug 07 2026 10:30:59\",\"vale1\":\"1320.00\",\"vole\":\"551\"},{\"dttm\":\"Fri Aug 07 2026 10:29:59\",\"vale1\":\"1320.00\",\"vole\":\"541\"},{\"dttm\":\"Fri Aug 07 2026 10:28:59\",\"vale1\":\"1319.40\",\"vole\":\"1873\"},{\"dttm\":\"Fri Aug 07 2026 10:27:59\",\"vale1\":\"1319.70\",\"vole\":\"4352\"},{\"dttm\":\"Fri Aug 07 2026 10:26:59\",\"vale1\":\"1319.00\",\"vole\":\"676\"},{\"dttm\":\"Fri Aug 07 2026 10:25:59\",\"vale1\":\"1319.00\",\"vole\":\"414\"},{\"dttm\":\"Fri Aug 07 2026 10:24:58\",\"vale1\":\"1319.00\",\"vole\":\"210\"},{\"dttm\":\…[truncated, total 6291 chars]
```
...
Reference&#32;&#35;18&#46;126adc17&#46;1786078912&#46;47f8b822
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;126adc17&#46;1786078912&#46;47f8b822</P>
</BODY>
</HTML>
...
> <tr> count: 17, bytes=323848

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP Today 2026 – Live Grey Market Premium &amp; Kostak Rates - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-no-defer="1…[truncated, total 323848 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=234291 | rendered_len=276743 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=147366 | sme: static status=200 bytes=149144 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=291844 | detail-2: static status=200 bytes=297658 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=2 | d1: main=86789b tables=11 rows=72 | d2: main=88740b tables=12 rows=81
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=234291 | rendered_len=278887 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> details_extracted=3 | avg_full=0.848 | avg_narrow=1.000 | pdf_on_allowlist=2 | pdf_off_allowlist=0 | third_ipo=leap-india-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.82 narrow=1.00 | d3:leap-india-ipo full=0.82 narrow=1.00
