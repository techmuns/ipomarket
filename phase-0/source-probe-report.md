...
Generated: 2026-08-19T11:38:02.278Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 518 | Use as primary source for Live & Upcoming tab. |
...
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 3238 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2754 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11141 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 4602 | NSE historical still blocked; use BSE historical as primary (official fallback). |
...
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 1063 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 9993 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 655 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 96 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 862 | Store URL as link-out; do not scrape per-PAN. |
...
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 1244 | PDF discovery selector may have drifted. |
...
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1327 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 334 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
...
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5141 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1014 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 1597 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3618 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4448 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 3032 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 518 ms
- Ran at (UTC): 2026-08-19T11:36:52.077Z
...
[
  {
    ...
    "symbol": "GAJA",
    "category": "Total",
    "noOfSharesOffered": "2.5328946E7",
    "noOfTime": "0.502364093634216",
    "noOfsharesBid": "1.2724353E7",
    "srNo": null
  },
  {
    ...
    "noOfTime": "0.6768914586755628",
    …[truncated, total 2440 chars]
```
...
> [static-primary] static ok: tr=0, bytes=6080 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=45141 (pdfs=19)
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=26000, fields=1

```
{
  "CurrDate": "Wed Aug 19 2026 16:01:20",
  "PrevClose": "1319.4",
  "LowVal": "1300",
  "HighVal": "1320",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "300000",
  "Data": "[{\"dttm\":\"Wed Aug 19 2026 16:01:20\",\"vale1\":\"1307.50\",\"vole\":\"0\"},{\"dttm\":\"Wed Aug 19 2026 16:00:04\",\"vale1\":\"1307.50\",\"vole\":\"0\"},{\"dttm\":\"Wed Aug 19 2026 15:59:43\",\"vale1\":\"1307.50\",\"vole\":\"550\"},{\"dttm\":\"Wed Aug 19 2026 15:58:46\",\"vale1\":\"1307.50\",\"vole\":\"377\"},{\"dttm\":\"Wed Aug 19 2026 15:57:26\",\"vale1\":\"1307.50\",\"vole\":\"109\"},{\"dttm\":\"Wed Aug 19 2026 15:56:46\",\"vale1\":\"1307.50\",\"vole\":\"1\"},{\"dttm\":\"Wed Aug 19 2026 15:55:58\",\"vale1\":\"1307.50\",\"vole\":\"3\"},{\"dttm\":\"Wed Aug…[truncated, total 30906 chars]
```
...
Reference&#32;&#35;18&#46;983b2f17&#46;1787139436&#46;24178ff0
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;983b2f17&#46;1787139436&#46;24178ff0</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 892450 chars]
```
...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="pingback" href="https://ipocentral.in/x…[truncated, total 523336 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=235304 | rendered_len=277902 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
<H1>Access Denied</H1>
 …[truncated, total 399 chars] ; [NSE IPO list] 10 IPOs; per-row keys: companyName, issueEndDate, issuePrice, issueSize, issueStartDate, series, status, symbol; sector fields: (none) ; [BSE IPO list] BSE HTML; sector-related words found: (none); bytes=13850
...
> mainboard: static status=200 bytes=149631 | sme: static status=200 bytes=150039 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=303487 | detail-2: static status=200 bytes=283522 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=2 | d1: main=89896b tables=12 rows=77 | d2: main=84816b tables=11 rows=65
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=235304 | rendered_len=278144 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
