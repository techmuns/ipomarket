...
Generated: 2026-07-24T06:04:18.294Z
...
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 357 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 742 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2258 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 594 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2807 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11604 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 3363 | NSE historical still blocked; use BSE historical as primary (official fallback). |
...
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 712 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10180 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 324 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 24 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 800 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 135 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 4954 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 746 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 1063 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 495 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1331 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 507 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 89 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 44 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4897 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
...
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 816 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 2106 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3802 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4412 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 106 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
| P-26b | Chittorgarh — detail field extraction retune (Phase 6A.1) | GREEN | - | JSON | 29 | Precision met (full=0.85 narrow=0.93). Ready for Phase 6A.2 planning approval. |
...
- Fallback: P-06
- Latency: 289 ms
- Ran at (UTC): 2026-07-24T06:03:11.789Z

> Total rows: 4, Active rows: 4
...
[
  {
    ...
    "noOfTime": "0.9329145728643216",
    "noOfsharesBid": "8577030.0",
    "srNo": null
  },
  {
    ...
    "noOfTime": "0.14637924275971878",
    "noOfsharesBid": "2100…[truncated, total 1660 chars]
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=9319, fields=1

```
{
  "CurrDate": "Fri Jul 24 2026 11:32:59",
  "PrevClose": "1275.35",
  "LowVal": "1260",
  "HighVal": "1285",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "100000",
  "Data": "[{\"dttm\":\"Fri Jul 24 2026 11:32:59\",\"vale1\":\"1277.90\",\"vole\":\"713\"},{\"dttm\":\"Fri Jul 24 2026 11:31:59\",\"vale1\":\"1278.80\",\"vole\":\"1219\"},{\"dttm\":\"Fri Jul 24 2026 11:30:59\",\"vale1\":\"1278.50\",\"vole\":\"1845\"},{\"dttm\":\"Fri Jul 24 2026 11:29:59\",\"vale1\":\"1279.10\",\"vole\":\"556\"},{\"dttm\":\"Fri Jul 24 2026 11:28:59\",\"vale1\":\"1279.90\",\"vole\":\"3876\"},{\"dttm\":\"Fri Jul 24 2026 11:27:59\",\"vale1\":\"1280.90\",\"vole\":\"2007\"},{\"dttm\":\"Fri Jul 24 2026 11:26:59\",\"vale1\":\"1281.50\",\"vole\":\"1002\"},{\"dt…[truncated, total 11214 chars]
```
...
Reference&#32;&#35;18&#46;a6adc17&#46;1784873014&#46;3e5c51a1
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;a6adc17&#46;1784873014&#46;3e5c51a1</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 842729 chars]
```
...
> <tr> count: 17, bytes=360721

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP 2026 - IPO Grey Market Premium, Latest GMP &amp; Kostak - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-no-defer="1"…[truncated, total 360721 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=232933 | rendered_len=273116 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=148191 | sme: static status=200 bytes=147924 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=272205 | detail-2: static status=200 bytes=320980 | challenges_detected=false
...
```
{
  ...
  "picked_detail_urls": [
    "https://www.chittorgarh.com/ipo/manipal-health-enterprises-ipo/2956/",
    "https://www.chittorgarh.com/ipo/xtranet-technologies-ipo/2688/"
  ],
  "detail_titles": [
    "Manipal Health Enterprises IPO Date, Price, GMP, Details",
...
> details_extracted=2 | avg_precision=0.550 | official_pdf_links_on_allowlist=1 | official_pdf_links_off_allowlist=2 | d1: main=82591b tables=10 rows=57 | d2: main=92102b tables=11 rows=75
...
```
{
  ...
  "details": [
    {
      "index": 1,
      "source_url": "https://www.chittorgarh.com/ipo/manipal-health-enterprises-ipo/2956/",
      "found_count": 5,
      "precision_ratio": 0.5,
      "tables_parsed": 10,
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=232933 | rendered_len=275128 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
