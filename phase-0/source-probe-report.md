...
Generated: 2026-08-02T06:12:16.482Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 294 | Use as primary source for Live & Upcoming tab. |
| P-02 | NSE — Upcoming IPOs | GREEN | 200 | JSON | 371 | Use as primary for Upcoming/Pipeline tab. |
| P-03 | NSE — Past/Recent IPOs | GREEN | 200 | JSON | 63 | Use as primary for Recently Listed. |
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 280 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 840 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 4089 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 432 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 3146 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11192 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 3873 | NSE historical still blocked; use BSE historical as primary (official fallback). |
...
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 523 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10429 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 303 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 45 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 470 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 97 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 5092 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 703 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 1068 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 213 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1376 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 517 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 103 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 1564 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4008 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 22693 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1146 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 935 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
| P-26 | Chittorgarh — detail field extraction (Phase 5C.3 calibration) | RED | - | JSON | 21 | Extraction precision below the §Y.9.1 threshold. Per the Phase 5C.3 acceptance gate, recommend NO for Chittorgarh ingestion and keep it reference-only / manual. |
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3392 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 22623 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 692 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 294 ms
- Ran at (UTC): 2026-08-02T06:10:30.845Z

> Total rows: 4, Active rows: 2

```
{
  "companyName": "MV Electrosystems Limited",
  "issueEndDate": "03-Aug-2026",
  "issuePrice": "Rs.400 to Rs.425",
  "issueSize": "3987491",
...
- URL: `https://www.nseindia.com/api/ipo-current-issue?symbol=MVELECTRO`
...
> Active candidate symbol: MVELECTRO · Top-level keys: 0, 1
...
[
  {
    ...
    "symbol": "MVELECTRO",
    "category": "Total",
    "noOfSharesOffered": "3987491.0",
    "noOfTime": "8.324131139104765",
    "noOfsharesBid": "3.3192398E7",
    "srNo": null
  },
  {
    "companyName": "Juniper Green Energy Limited",
    "issueEndDate": "03-Aug-2026",
    "issuePrice": "Rs.214 to Rs.225",
    "issueSize": "58916709",
    "issueStartDate": "30-Jul-2026",
    "series": "EQ",
    "status": "Active",
    "symbol": "JNPR",
    "category": "Total",
    "noOfSharesOffered": "5.8916709E7",
    "noOfTime": "0.3897118897119661",
    "noOfsharesB…[truncated, total 842 chars]
```
...
> [static-primary] static ok: tr=0, bytes=6080 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=46190 (pdfs=20)
...
```
{
  ...
  "first_3_pdfs": [
    ...
    {
      "url": "https://www.sebi.gov.in/sebi_data/commondocs/jul-2026/Indian%20Gas%20Exchange%20Limited_p.pdf",
      "link_text": "Indian Gas Exchange Limited - Draft Abridged prospectus",
      "source": "static-alt"
    },
    {
...
> discovery=sebi-publicissues-pdfs.json; pdf_url=/sebi_data/commondocs/jul-2026/YOGIJI%20DIGI%20LIMITED_p.pdf; bytes=663356; page_count=11; pdf-parse=ok
...
```
{
  ...
  "link_text": "YOGIJI DIGI LIMITED - Draft Abridged prospectus",
  "bytes": 663356,
  "sha256": "bda60651e0cac09f…",
  "magic": "%PDF",
  "page_count": 11,
  "cover_text_first_200": "YOGIJI DIGI LIMITED (FORMERLY KNOWN AS YOGIJI DIGI PRIVATE LIMITED)\nCORPORATE IDENTITY NUMBER: U74899HR1993PLC032121\nREGISTERED AND CORPORATE CONTACT PERSON EMAIL AND TELEPHONE WEBSITE\nOFFICE\nPlot No."
}
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22095 chars] ; [bse:RELIANCE] BSE rows=26640, fields=1

```
{
  "CurrDate": "Fri Jul 31 2026 16:01:28",
  "PrevClose": "1294.4",
  "LowVal": "1290",
  "HighVal": "1310",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "200000",
  "Data": "[{\"dttm\":\"Fri Jul 31 2026 16:01:28\",\"vale1\":\"1307.30\",\"vole\":\"0\"},{\"dttm\":\"Fri Jul 31 2026 16:00:00\",\"vale1\":\"1307.30\",\"vole\":\"0\"},{\"dttm\":\"Fri Jul 31 2026 15:58:30\",\"vale1\":\"1307.30\",\"vole\":\"0\"},{\"dttm\":\"Fri Jul 31 2026 15:57:38\",\"vale1\":\"1307.30\",\"vole\":\"0\"},{\"dttm\":\"Fri Jul 31 2026 15:56:11\",\"vale1\":\"1307.30\",\"vole\":\"11\"},{\"dttm\":\"Fri Jul 31 2026 15:52:23\",\"vale1\":\"1307.30\",\"vole\":\"0\"},{\"dttm\":\"Fri Jul 31 2026 15:51:48\",\"vale1\":\"1307.30\",\"vole\":\"2\"},{\"dttm\":\"Fri Jul 31 2…[truncated, total 31630 chars]
```
...
Reference&#32;&#35;18&#46;244e4e68&#46;1785651056&#46;83640b6
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;244e4e68&#46;1785651056&#46;83640b6</P>
</BODY>
</HTML>
...
```
{
  ...
  "Anawil Wire and Engineering Limited": "ANAWIL"
}
```
...
```
{
  "MV Electrosystems Limited": null,
  "Juniper Green Energy Limited": null,
  "Ardee Industries Limited": null,
  "Anawil Wire and Engineering Limited": null
}
```
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 865804 chars]
```
...
> <tr> count: 19, bytes=317790

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP 2026 - IPO Grey Market Premium, Latest GMP &amp; Kostak - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-no-defer="1"…[truncated, total 317790 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=232960 | rendered_len=276455 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
<H1>Access Denied</H1>
 …[truncated, total 399 chars] ; [NSE IPO list] 4 IPOs; per-row keys: companyName, issueEndDate, issuePrice, issueSize, issueStartDate, series, status, symbol; sector fields: (none) ; [BSE IPO list] BSE HTML; sector-related words found: (none); bytes=13850
...
- Status code: 200
- Response type: HTML
- Fields found: mainboard dashboard reachable, sme dashboard reachable, 41 detail URL(s) discovered, detail-1 reachable, detail-2 reachable
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> mainboard: static status=200 bytes=146104 | sme: static status=200 bytes=148422 | detail_urls_discovered=41 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=295902 | detail-2: static status=200 bytes=276496 | challenges_detected=false
...
```
{
  ...
  "discovered_detail_count": 41,
  "picked_detail_urls": [
    "https://www.chittorgarh.com/ipo/technocraft-ventures-ipo/2565/",
    "https://www.chittorgarh.com/ipo/ardee-industries-ipo/2860/"
  ],
  "detail_titles": [
    "Technocraft Ventures IPO Date, Price, GMP, Review, Details",
    "Ardee Industries IPO Date, Price, GMP, Review, Details"
  ],
...
> details_extracted=2 | avg_precision=0.350 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=2 | d1: main=87365b tables=10 rows=65 | d2: main=83044b tables=12 rows=64
...
```
{
  ...
  "details": [
    {
      "index": 1,
      "source_url": "https://www.chittorgarh.com/ipo/technocraft-ventures-ipo/2565/",
      "found_count": 2,
      "precision_ratio": 0.2,
      "tables_parsed": 10,
    ...
    {
      "index": 2,
      "source_url": "https://www.chittorgarh.com/ipo/ardee-industries-ipo/2860/",
      "found_count": 5,
      "precision_ratio": 0.5,
      "tables_parsed": 12,
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=IPO - Check IPO Date, Details, Price & Allotment | Upstox | render_mode=server-rendered | raw_len=232384 | rendered_len=275820 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11

```
{
  "title": "IPO - Check IPO Date, Details, Price & Allotment | Upstox",
  "headings_top10": [
    "Vegorama Punjabi Angithi IPO",
    "Vegorama Punjabi Angithi Limited IPO Details",
    "Checklist",
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (mv-electrosystems-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> third_ipo_status=current | third_ipo_slug=mv-electrosystems-ipo | third_ipo_reason="current-open: list "mainboard" row date range "30 Jul - 03 Aug" covers today" | detail-1: static status=200 bytes=371348 | detail-2: static status=200 bytes=339652 | detail-3: static status=200 bytes=323711 | challenges_detected=false | robots_classification=allowed-prior-flag-was-over-match | robots_ipo_disallowed=false | robots: robots.txt: detail paths ALLOWED for *; the Phase 6A.1.1 flag was an OVER-MATCH (loose p.startsWith('/ipo') hit an unrelated rule). /ipo/onemi-technology-ipo/2576/→allowed (no matching rule); /ipo/bagmane-reit/3090/→allowed (no matching rule); /ipo/m-r-maniveni-ipo/2627/→allowed (no matching rule)

```
{
  "third_ipo": {
    "slug": "mv-electrosystems-ipo",
    "url": "https://www.chittorgarh.com/ipo/mv-electrosystems-ipo/2800/",
    "status": "current",
    "reason": "current-open: list \"mainboard\" row date range \"30 Jul - 03 Aug\" covers today",
    "date_text": "30 Jul - 03 Aug",
  ...
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "MV Electrosystems IPO Date, Price, GMP, Review, Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.848 | avg_narrow=1.000 | pdf_on_allowlist=2 | pdf_off_allowlist=1 | third_ipo=mv-electrosystems-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.82 narrow=1.00 | d3:mv-electrosystems-ipo full=0.82 narrow=1.00
