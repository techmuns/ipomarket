...
Generated: 2026-08-19T03:57:48.628Z
...
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 655 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 3261 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 3332 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11232 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 2679 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 47 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 410 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 777 | Skip; NSE primary covers this. |
...
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 67 | Fall back to per-issue page scrape or manual seed. |
...
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 738 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 251 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 4478 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 580 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 356 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 103 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4747 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5321 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 690 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 2351 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 2105 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 314 ms
- Ran at (UTC): 2026-08-19T03:56:38.950Z
...
- URL: `https://www.nseindia.com/api/ipo-current-issue?symbol=GAJA`
...
> Active candidate symbol: GAJA · Top-level keys: 0, 1, 2, 3, 4, 5
...
[
  ...
  },
  {
    ...
    "symbol": "SHANKESH",
    "category": "Total",
    "noOfSharesOffered": "2.76374E7",
    "noOfTime": "0.23416963969114316",
    "noOfsharesBid": "6471840.0"…[truncated, total 2412 chars]
```
...
> [static-primary] static ok: tr=0, bytes=6080 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=45443 (pdfs=20)
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22095 chars] ; [bse:RELIANCE] BSE rows=742, fields=1

```
{
  "CurrDate": "Wed Aug 19 2026 09:25:59",
  "PrevClose": "1319.4",
  "LowVal": "1312",
  "HighVal": "1320",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "15000",
  "Data": "[{\"dttm\":\"Wed Aug 19 2026 09:25:59\",\"vale1\":\"1313.50\",\"vole\":\"3561\"},{\"dttm\":\"Wed Aug 19 2026 09:24:59\",\"vale1\":\"1314.00\",\"vole\":\"3949\"},{\"dttm\":\"Wed Aug 19 2026 09:23:59\",\"vale1\":\"1315.95\",\"vole\":\"802\"},{\"dttm\":\"Wed Aug 19 2026 09:22:59\",\"vale1\":\"1317.70\",\"vole\":\"193\"},{\"dttm\":\"Wed Aug 19 2026 09:21:59\",\"vale1\":\"1317.55\",\"vole\":\"165\"},{\"dttm\":\"Wed Aug 19 2026 09:20:59\",\"vale1\":\"1317.70\",\"vole\":\"738\"},{\"dttm\":\"Wed Aug 19 2026 09:19:59\",\"vale1\":\"1317.20\",\"vole\":\"455\"},{\"dttm\":…[truncated, total 1111 chars]
```
...
Reference&#32;&#35;18&#46;d11c2117&#46;1787111821&#46;a882c509
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;d11c2117&#46;1787111821&#46;a882c509</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 890795 chars]
```
...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="pingback" href="https://ipocentral.in/x…[truncated, total 517727 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=235304 | rendered_len=279856 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=149577 | sme: static status=200 bytes=150039 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=303487 | detail-2: static status=200 bytes=277209 | challenges_detected=false
...
```
{
  ...
  "picked_detail_urls": [
    "https://www.chittorgarh.com/ipo/symbiotec-pharmalab-ipo/2815/",
    "https://www.chittorgarh.com/ipo/hy-tech-engineers-ipo/2591/"
  ],
  "detail_titles": [
    "Symbiotec Pharmalab IPO Date, Price, GMP, Review, Details",
    "Hy-Tech Engineers IPO Date, Price, GMP, Review, Details"
  ],
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=2 | d1: main=89896b tables=12 rows=77 | d2: main=83145b tables=11 rows=62
...
```
{
  ...
  "details": [
    {
      "index": 1,
      "source_url": "https://www.chittorgarh.com/ipo/symbiotec-pharmalab-ipo/2815/",
      "found_count": 5,
      "precision_ratio": 0.5,
      "tables_parsed": 12,
    ...
    {
      "index": 2,
      "source_url": "https://www.chittorgarh.com/ipo/hy-tech-engineers-ipo/2591/",
      "found_count": 5,
      "precision_ratio": 0.5,
      "tables_parsed": 11,
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=235304 | rendered_len=277735 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (gaja-alternative-asset-management-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> third_ipo_status=current | third_ipo_slug=gaja-alternative-asset-management-ipo | third_ipo_reason="current-open: list "mainboard" row date range "19 - 21 Aug" covers today" | detail-1: static status=200 bytes=367815 | detail-2: static status=200 bytes=341902 | detail-3: static status=200 bytes=290092 | challenges_detected=false | robots_classification=allowed-prior-flag-was-over-match | robots_ipo_disallowed=false | robots: robots.txt: detail paths ALLOWED for *; the Phase 6A.1.1 flag was an OVER-MATCH (loose p.startsWith('/ipo') hit an unrelated rule). /ipo/onemi-technology-ipo/2576/→allowed (no matching rule); /ipo/bagmane-reit/3090/→allowed (no matching rule); /ipo/m-r-maniveni-ipo/2627/→allowed (no matching rule)

```
{
  "third_ipo": {
    "slug": "gaja-alternative-asset-management-ipo",
    "url": "https://www.chittorgarh.com/ipo/gaja-alternative-asset-management-ipo/2527/",
    "status": "current",
    "reason": "current-open: list \"mainboard\" row date range \"19 - 21 Aug\" covers today",
    "date_text": "19 - 21 Aug",
  ...
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "Gaja Alternative Asset Management IPO Date, Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.848 | avg_narrow=1.000 | pdf_on_allowlist=2 | pdf_off_allowlist=1 | third_ipo=gaja-alternative-asset-management-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.82 narrow=1.00 | d3:gaja-alternative-asset-management-ipo full=0.82 narrow=1.00
