...
Generated: 2026-07-18T12:06:51.326Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 20367 | Use as primary source for Live & Upcoming tab. |
...
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 41038 | Source reachable; 0 SME rows in current snapshot. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2345 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11132 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 81099 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 92 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 20245 | Deterministic mapping; no manual override file needed for v1. |
...
| P-13 | KFintech — landing | GREEN | 200 | HTML | 88 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 5324 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 1061 | Store URL as link-out only. |
...
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1365 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1389 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 320 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 467 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4596 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4168 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 857 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3380 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4187 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
...
| P-26b | Chittorgarh — detail field extraction retune (Phase 6A.1) | GREEN | - | JSON | 35 | Precision met (full=0.82 narrow=0.93). Ready for Phase 6A.2 planning approval. |
...
- Fallback: P-06
- Latency: 20367 ms
- Ran at (UTC): 2026-07-18T12:02:41.228Z
...
> Active candidate symbol: CMLL · Network error: This operation was aborted
...
Reference&#32;&#35;18&#46;65c83017&#46;1784376345&#46;6bef3214
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;65c83017&#46;1784376345&#46;6bef3214</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 831144 chars]
```
...
> <tr> count: 15, bytes=346160

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP 2026 - IPO Grey Market Premium, Latest GMP &amp; Kostak - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-no-defer="1"…[truncated, total 346160 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=266925 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=147921 | sme: static status=200 bytes=146969 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=295040 | detail-2: static status=200 bytes=278658 | challenges_detected=false
...
```
{
  ...
  "picked_detail_urls": [
    ...
    "https://www.chittorgarh.com/ipo/lohia-corp-ipo/2574/"
  ],
  "detail_titles": [
    "Xtranet Technologies IPO Date, Price, GMP, Review, Details",
    "Lohia Corp IPO Date, Price, GMP, Review, Analysis &amp; Details"
  ],
...
> details_extracted=2 | avg_precision=0.350 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=2 | d1: main=88165b tables=10 rows=65 | d2: main=83064b tables=8 rows=58
...
```
{
  ...
  "details": [
    ...
    {
      "index": 2,
      "source_url": "https://www.chittorgarh.com/ipo/lohia-corp-ipo/2574/",
      "found_count": 2,
      "precision_ratio": 0.2,
      "tables_parsed": 8,
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=266792 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
