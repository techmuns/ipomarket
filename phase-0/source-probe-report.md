...
Generated: 2026-06-21T13:20:03.522Z
...
| P-02 | NSE — Upcoming IPOs | GREEN | 200 | JSON | 281 | Use as primary for Upcoming/Pipeline tab. |
| P-03 | NSE — Past/Recent IPOs | GREEN | 200 | JSON | 43 | Use as primary for Recently Listed. |
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 410 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 1067 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2011 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 309 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 3095 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 31119 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 4773 | NSE historical still blocked; use BSE historical as primary (official fallback). |
...
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 708 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10161 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 268 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 319 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 527 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 141 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 5244 | Store URL as link-out only. |
...
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 199 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1327 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 638 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 403 | BLOCKED | 105 | Skip. |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 328 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4172 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4532 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 21566 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 153 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3442 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4287 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 2055 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 309 ms
- Ran at (UTC): 2026-06-21T13:18:13.822Z
...
> Active candidate symbol: TURTLEMINT · Top-level keys: 0, 1
...
[
  {
    ...
    "noOfTime": "0.3067731270537202",
    "noOfsharesBid": "1.0093412E7",
    "srNo": null
  },
  {
...
<!DOCTYPE html><html lang="en" data-critters-container=""><head>
    ...
    <meta name="keywords" content="BSE SENSEX,…[truncated, total 13272 chars]
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=27072, fields=1

```
{
  "CurrDate": "Fri Jun 19 2026 16:01:34",
  "PrevClose": "1327.75",
  "LowVal": "1300",
  "HighVal": "1340",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "125000",
  "Data": "[{\"dttm\":\"Fri Jun 19 2026 16:01:34\",\"vale1\":\"1309.35\",\"vole\":\"0\"},{\"dttm\":\"Fri Jun 19 2026 16:00:01\",\"vale1\":\"1309.35\",\"vole\":\"0\"},{\"dttm\":\"Fri Jun 19 2026 15:59:40\",\"vale1\":\"1309.35\",\"vole\":\"0\"},{\"dttm\":\"Fri Jun 19 2026 15:58:30\",\"vale1\":\"1309.35\",\"vole\":\"0\"},{\"dttm\":\"Fri Jun 19 2026 15:57:50\",\"vale1\":\"1309.35\",\"vole\":\"0\"},{\"dttm\":\"Fri Jun 19 2026 15:56:52\",\"vale1\":\"1309.35\",\"vole\":\"7\"},{\"dttm\":\"Fri Jun 19 2026 15:55:59\",\"vale1\":\"1309.35\",\"vole\":\"0\"},{\"dttm\":\"Fri Jun 19 2…[truncated, total 32135 chars]
```
...
Reference&#32;&#35;18&#46;bdb42d17&#46;1782047939&#46;6f20b08
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;bdb42d17&#46;1782047939&#46;6f20b08</P>
</BODY>
</HTML>
...
```
{
  ...
  "Shreedhar Spinners Limited": "SHREEDHAR"
}
```
...
```
{
  ...
  "Shreedhar Spinners Limited": null
}
```
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 834292 chars]
```
...
```
<!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=Edge"><meta name="robots" content="noindex,nofollow"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="content-security-policy" content="default-src &#39;none&#39;; script-src &#39;nonce-4zLuvdXBlnaZoT8UBo9mHY&#39; &#39;unsafe-eval&#39; https://challenges.cloudflare.com; script-s…[truncated, total 5747 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=266409 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
<H1>Access Denied</H1>
 …[truncated, total 399 chars] ; [NSE IPO list] 4 IPOs; per-row keys: companyName, issueEndDate, issuePrice, issueSize, issueStartDate, series, status, symbol; sector fields: (none) ; [BSE IPO list] BSE HTML; sector-related words found: (none); bytes=12615
...
> mainboard: static status=200 bytes=146084 | sme: static status=200 bytes=148730 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=263913 | detail-2: static status=200 bytes=282998 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.400 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=1 | d1: main=79807b tables=8 rows=49 | d2: main=84331b tables=10 rows=62
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=267255 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
