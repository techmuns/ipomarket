...
Generated: 2026-09-10T08:05:48.186Z
...
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 392 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 745 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 3736 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2715 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11100 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 2530 | NSE historical still blocked; use BSE historical as primary (official fallback). |
...
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 292 | Rely on NSE only (P-04). |
...
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 1039 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 900 | Store URL as link-out only. |
...
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1274 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 200 | HTML | 128 | Skip. |
| P-22 | GMP — InvestorGain | RED | 200 | HTML | 129 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4066 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5125 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 496 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 137 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 5079 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 1023 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 364 ms
- Ran at (UTC): 2026-09-10T08:04:46.515Z
...
[
  {
    ...
    "noOfTime": "0.24241250999761932",
    "noOfsharesBid": "2741126.0",
    "srNo": null
  },
  {
    ...
    "noOfTime": "2.042931138545901",
    "noOfshar…[truncated, total 4564 chars]
```
...
> [static-primary] static ok: tr=0, bytes=6035 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=44833 (pdfs=15)
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22095 chars] ; [bse:RELIANCE] BSE rows=17515, fields=1

```
{
  "CurrDate": "Thu Sep 10 2026 13:34:59",
  "PrevClose": "1281",
  "LowVal": "1270",
  "HighVal": "1285",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "250000",
  "Data": "[{\"dttm\":\"Thu Sep 10 2026 13:34:59\",\"vale1\":\"1273.40\",\"vole\":\"520\"},{\"dttm\":\"Thu Sep 10 2026 13:33:59\",\"vale1\":\"1273.90\",\"vole\":\"405\"},{\"dttm\":\"Thu Sep 10 2026 13:32:59\",\"vale1\":\"1274.00\",\"vole\":\"621\"},{\"dttm\":\"Thu Sep 10 2026 13:31:59\",\"vale1\":\"1273.50\",\"vole\":\"593\"},{\"dttm\":\"Thu Sep 10 2026 13:30:59\",\"vale1\":\"1273.50\",\"vole\":\"461\"},{\"dttm\":\"Thu Sep 10 2026 13:29:59\",\"vale1\":\"1274.20\",\"vole\":\"16289\"},{\"dttm\":\"Thu Sep 10 2026 13:28:59\",\"vale1\":\"1273.70\",\"vole\":\"8168\"},{\"dttm\":…[truncated, total 20871 chars]
```
...
Reference&#32;&#35;18&#46;650f3417&#46;1789027509&#46;aaade0eb
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;650f3417&#46;1789027509&#46;aaade0eb</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 911569 chars]
```
...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="pingback" href="https://ipocentral.in/x…[truncated, total 536843 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=346702 | rendered_len=391411 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=151514 | sme: static status=200 bytes=150062 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=298423 | detail-2: static status=200 bytes=262765 | challenges_detected=false
...
- Response type: JSON
- Fields found: d1.company_name[high], d1.issue_size_cr[high], d1.price_band[high], d1.lot_size[high], d1.listing_date[high], d2.company_name[high], d2.listing_date[high], d2.official_pdf_links[high]
- Fields missing: d1.open_date[missing], d1.close_date[missing], d1.registrar[missing], d1.brlms[missing], d1.official_pdf_links[missing], d2.issue_size_cr[rejected-low], d2.price_band[missing], d2.lot_size[missing], d2.open_date[missing], d2.close_date[missing], d2.registrar[missing], d2.brlms[missing]
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> details_extracted=2 | avg_precision=0.400 | official_pdf_links_on_allowlist=1 | official_pdf_links_off_allowlist=0 | d1: main=89135b tables=11 rows=70 | d2: main=78312b tables=9 rows=66
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=346702 | rendered_len=391824 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
