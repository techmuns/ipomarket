...
Generated: 2026-09-22T15:35:03.483Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 72 | Use as primary source for Live & Upcoming tab. |
...
| P-04 | NSE — Live Subscription | RED | 0 | ERROR | 25001 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 41043 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 3393 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | RED | 0 | ERROR | 1079 | Download failed; fall back to P-10 exchange-side DRHP archive. |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 31228 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 80712 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 34 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 351 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 1175 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10487 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 293 | Rely on NSE only (P-04). |
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 20339 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 593 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 129 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 961 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 709 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 1051 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 207 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1401 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1263 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 200 | HTML | 85 | Skip. |
| P-22 | GMP — InvestorGain | RED | 200 | HTML | 92 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4809 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5566 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1416 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
...
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 5044 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 2080 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 72 ms
- Ran at (UTC): 2026-09-22T15:30:55.871Z
...
> Total rows: 10, Forthcoming/upcoming rows: 9
...
> Total rows: 10, Past/closed/listed rows: 0
...
> Active candidate symbol: VARMORA · Network error: This operation was aborted
...
> [nse:RELIANCE] NSE non-200 (status=0, err=This operation was aborted) ; [nse:TCS] NSE non-200 (status=0, err=This operation was aborted) ; [bse:RELIANCE] BSE rows=26197, fields=1

```
{
  "CurrDate": "Tue Sep 22 2026 16:01:18",
  "PrevClose": "1247.7",
  "LowVal": "1235",
  "HighVal": "1255",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "150000",
  "Data": "[{\"dttm\":\"Tue Sep 22 2026 16:01:18\",\"vale1\":\"1242.00\",\"vole\":\"0\"},{\"dttm\":\"Tue Sep 22 2026 16:00:03\",\"vale1\":\"1242.00\",\"vole\":\"0\"},{\"dttm\":\"Tue Sep 22 2026 15:59:46\",\"vale1\":\"1242.00\",\"vole\":\"10\"},{\"dttm\":\"Tue Sep 22 2026 15:58:52\",\"vale1\":\"1242.00\",\"vole\":\"40\"},{\"dttm\":\"Tue Sep 22 2026 15:57:46\",\"vale1\":\"1242.00\",\"vole\":\"0\"},{\"dttm\":\"Tue Sep 22 2026 15:56:53\",\"vale1\":\"1242.00\",\"vole\":\"3\"},{\"dttm\":\"Tue Sep 22 2026 15:55:54\",\"vale1\":\"1242.00\",\"vole\":\"4\"},{\"dttm\":\"Tue Sep 22 …[truncated, total 31115 chars]
```
...
Reference&#32;&#35;18&#46;5969dc17&#46;1790091239&#46;2548269
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;5969dc17&#46;1790091239&#46;2548269</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 981810 chars]
```
...
> <tr> count: 0, bytes=554307

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP Today 2026 – Live Grey Market Premium &amp; Kostak Rates - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-cfasync="fa…[truncated, total 554307 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=347835 | rendered_len=392836 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=149221 | sme: static status=200 bytes=149550 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=282390 | detail-2: static status=200 bytes=282738 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=2 | d1: main=84197b tables=12 rows=71 | d2: main=84351b tables=12 rows=66
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=347835 | rendered_len=392812 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
