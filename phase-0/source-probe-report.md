...
Generated: 2026-09-09T15:08:14.422Z
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2833 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 12279 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 2604 | NSE historical still blocked; use BSE historical as primary (official fallback). |
...
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 484 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10247 | Skip if NSE Emerge is GREEN. |
...
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 541 | Store URL as link-out; do not scrape per-PAN. |
...
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 762 | Store URL as link-out only. |
...
| P-21 | GMP — IPO Central | RED | 200 | HTML | 345 | Skip. |
| P-22 | GMP — InvestorGain | RED | 200 | HTML | 151 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4352 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | RED | - | ERROR | 30064 | Blocked from GH Actions runner. Use screenshots/PDF exports as IA reference. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 2229 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 274 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3493 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | RED | - | ERROR | 30063 | Blocked from GH Actions runner. Use screenshots/PDF exports as IA reference. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 2978 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 345 ms
- Ran at (UTC): 2026-09-09T15:06:17.652Z
...
[
  ...
  },
  {
    ...
    "noOfTime": "0.8446596975628938",
    "noOfsh…[truncated, total 4561 chars]
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22095 chars] ; [bse:RELIANCE] BSE rows=26343, fields=1
...
Reference&#32;&#35;18&#46;670f3417&#46;1788966399&#46;30f3e122
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;670f3417&#46;1788966399&#46;30f3e122</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 895730 chars]
```
...
<head>
    ...
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="pingback" href="https://ipocentral.in/x…[truncated, total 537302 chars]
```
...
> mainboard: static status=200 bytes=151115 | sme: static status=200 bytes=147641 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=254094 | detail-2: static status=200 bytes=280649 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.200 | official_pdf_links_on_allowlist=1 | official_pdf_links_off_allowlist=0 | d1: main=76369b tables=9 rows=66 | d2: main=84117b tables=10 rows=60
