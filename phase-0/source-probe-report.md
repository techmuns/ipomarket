...
Generated: 2026-05-27T07:14:41.551Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | YELLOW | 200 | JSON | 658 | Source reachable but 0 rows in current snapshot. category=ipo appears to be mainboard-only; if today's only IPOs are SME, P-05 should satisfy the IPO-list-source gate. |
| P-02 | NSE — Upcoming IPOs | YELLOW | 200 | JSON | 233 | Source reachable but 0 upcoming rows in current snapshot. category=ipo is mainboard-only; SME pipeline lives in P-05. |
...
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 1142 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2493 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 4382 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11106 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 5920 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 30 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | RED | 200 | JSON | 34 | Maintain a manual override file for IPOs whose symbol drifts post-listing. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 623 | Skip; NSE primary covers this. |
| P-06b | BSE SME — Public Issues | RED | 0 | ERROR | 10133 | Skip if NSE Emerge is GREEN. |
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 400 | Rely on NSE only (P-04). |
...
| P-13 | KFintech — landing | GREEN | 200 | HTML | 227 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 4837 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 1248 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 1178 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 248 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1923 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1686 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 403 | BLOCKED | 78 | Skip. |
...
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4752 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1729 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 3336 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3519 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4647 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 2447 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Latency: 658 ms
- Ran at (UTC): 2026-05-27T07:13:22.827Z
...
> [static-primary] static non-200 (status=0, err=fetch failed) (pdfs=0) ; [static-alt] static ok: tr=26, bytes=46183 (pdfs=19)
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=14061, fields=1

```
{
  "CurrDate": "Wed May 27 2026 12:42:59",
  "PrevClose": "1356.9",
  "LowVal": "1350",
  "HighVal": "1365",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "125000",
  "Data": "[{\"dttm\":\"Wed May 27 2026 12:42:59\",\"vale1\":\"1354.50\",\"vole\":\"840\"},{\"dttm\":\"Wed May 27 2026 12:41:59\",\"vale1\":\"1354.50\",\"vole\":\"48\"},{\"dttm\":\"Wed May 27 2026 12:40:59\",\"vale1\":\"1354.50\",\"vole\":\"232\"},{\"dttm\":\"Wed May 27 2026 12:39:59\",\"vale1\":\"1354.40\",\"vole\":\"1472\"},{\"dttm\":\"Wed May 27 2026 12:38:59\",\"vale1\":\"1355.00\",\"vole\":\"289\"},{\"dttm\":\"Wed May 27 2026 12:37:59\",\"vale1\":\"1355.00\",\"vole\":\"341\"},{\"dttm\":\"Wed May 27 2026 12:36:59\",\"vale1\":\"1355.20\",\"vole\":\"54\"},{\"dttm\":\"…[truncated, total 16795 chars]
```
...
Reference&#32;&#35;18&#46;73cfdb17&#46;1779866030&#46;8d964383
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;73cfdb17&#46;1779866030&#46;8d964383</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 816475 chars]
```
...
```
<!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=Edge"><meta name="robots" content="noindex,nofollow"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="content-security-policy" content="default-src &#39;none&#39;; script-src &#39;nonce-B95LZ7gCFGlZcpsZwbyO8p&#39; &#39;unsafe-eval&#39; https://challenges.cloudflare.com; script-s…[truncated, total 5747 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=267345 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=146961 | sme: static status=200 bytes=149520 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=286322 | detail-2: static status=200 bytes=318296 | challenges_detected=false
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=265235 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
