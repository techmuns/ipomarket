...
Generated: 2026-07-21T12:44:28.787Z
...
| P-02 | NSE — Upcoming IPOs | GREEN | 200 | JSON | 326 | Use as primary for Upcoming/Pipeline tab. |
| P-03 | NSE — Past/Recent IPOs | GREEN | 200 | JSON | 30 | Use as primary for Recently Listed. |
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 375 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 849 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2248 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 506 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2701 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11106 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 5244 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 22 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 278 | Deterministic mapping; no manual override file needed for v1. |
...
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 465 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 120 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 4438 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 1056 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 1179 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 259 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 9579 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 577 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 103 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 42 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4080 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4568 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
...
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 97 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3393 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4122 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 973 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 310 ms
- Ran at (UTC): 2026-07-21T12:43:13.586Z
...
> Total rows: 5, Forthcoming/upcoming rows: 4
...
> Active candidate symbol: CMLL · Top-level keys: 0, 1
...
[
  {
    ...
    "noOfTime": "97.15961097120518",
    "noOfsharesBid": "7.6132532E8",
    "srNo": null
  },
  {
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22096 chars] ; [bse:RELIANCE] BSE rows=27172, fields=1

```
{
  "CurrDate": "Tue Jul 21 2026 16:01:33",
  "PrevClose": "1323.25",
  "LowVal": "1300",
  "HighVal": "1325",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "100000",
  "Data": "[{\"dttm\":\"Tue Jul 21 2026 16:01:33\",\"vale1\":\"1303.65\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 21 2026 16:00:01\",\"vale1\":\"1303.65\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 21 2026 15:59:37\",\"vale1\":\"1303.65\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 21 2026 15:58:33\",\"vale1\":\"1303.65\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 21 2026 15:56:33\",\"vale1\":\"1303.65\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 21 2026 15:55:53\",\"vale1\":\"1303.65\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 21 2026 15:54:46\",\"vale1\":\"1303.65\",\"vole\":\"0\"},{\"dttm\":\"Tue Jul 21 2…[truncated, total 32259 chars]
```
...
Reference&#32;&#35;18&#46;6fc83017&#46;1784637817&#46;b238ef68
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;6fc83017&#46;1784637817&#46;b238ef68</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premium Price &#8211; IPO Watch</title>
<meta name='robots' content='max-image-preview:large' />
<link rel="alternate" type="application/rss+xml" title="IPO Watch &raquo; Feed" href="https://ipowatch.in/feed/" />
<link rel="alternate" type="application/rss+xml" titl…[truncated, total 812877 chars]
```
...
> <tr> count: 16, bytes=312606

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP 2026 - IPO Grey Market Premium, Latest GMP &amp; Kostak - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-no-defer="1"…[truncated, total 312606 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=266777 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=147556 | sme: static status=200 bytes=147935 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=295040 | detail-2: static status=200 bytes=314495 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=1 | d1: main=88165b tables=10 rows=65 | d2: main=94045b tables=11 rows=77
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=265526 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (metalic-technoforge-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> third_ipo_status=current | third_ipo_slug=metalic-technoforge-ipo | third_ipo_reason="current-open: list "sme" row date range "21 - 23 Jul" covers today" | detail-1: static status=200 bytes=352661 | detail-2: static status=200 bytes=325415 | detail-3: static status=200 bytes=335625 | challenges_detected=false | robots_classification=allowed-prior-flag-was-over-match | robots_ipo_disallowed=false | robots: robots.txt: detail paths ALLOWED for *; the Phase 6A.1.1 flag was an OVER-MATCH (loose p.startsWith('/ipo') hit an unrelated rule). /ipo/onemi-technology-ipo/2576/→allowed (no matching rule); /ipo/bagmane-reit/3090/→allowed (no matching rule); /ipo/m-r-maniveni-ipo/2627/→allowed (no matching rule)

```
{
  "third_ipo": {
    "slug": "metalic-technoforge-ipo",
    "url": "https://www.chittorgarh.com/ipo/metalic-technoforge-ipo/2993/",
    "status": "current",
    "reason": "current-open: list \"sme\" row date range \"21 - 23 Jul\" covers today",
    "date_text": "21 - 23 Jul",
    "source_list": "sme"
  },
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "Metalic Technoforge IPO Date, Price, GMP, Review, Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.818 | avg_narrow=0.933 | pdf_on_allowlist=2 | pdf_off_allowlist=2 | third_ipo=metalic-technoforge-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.73 narrow=0.80 | d3:metalic-technoforge-ipo full=0.82 narrow=1.00
