...
Generated: 2026-06-05T20:59:24.696Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 20614 | Use as primary source for Live & Upcoming tab. |
| P-02 | NSE — Upcoming IPOs | GREEN | 200 | JSON | 308 | Use as primary for Upcoming/Pipeline tab. |
| P-03 | NSE — Past/Recent IPOs | GREEN | 200 | JSON | 44 | Use as primary for Recently Listed. |
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 20322 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 41151 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 3278 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2919 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11042 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 81711 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 38 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 20275 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 884 | Skip; NSE primary covers this. |
...
| P-11 | Registrar resolution (from NSE list) | RED | 200 | JSON | 37 | Fall back to per-issue page scrape or manual seed. |
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 1218 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 162 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 4790 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 1300 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 953 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 246 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1532 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 1517 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | RED | 403 | BLOCKED | 111 | Skip. |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 132 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 5585 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 5308 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1024 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 220 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3645 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4706 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 2884 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 20614 ms
- Ran at (UTC): 2026-06-05T20:55:11.992Z
...
> Total rows: 2, Past/closed/listed rows: 1
...
[
  {
    ...
    "noOfTime": "1.2073673428877538",
    "noOfsharesBid": "2.6081559E7",
    "srNo": null
  },
  {
    ...
    "noOfTime": "93.46212195576015",
    "noOfsha…[truncated, total 1154 chars]
```
...
> [nse:RELIANCE] NSE non-200 (status=0, err=This operation was aborted) ; [nse:TCS] NSE non-200 (status=0, err=This operation was aborted) ; [bse:RELIANCE] BSE rows=27229, fields=1

```
{
  "CurrDate": "Fri Jun 05 2026 16:01:32",
  "PrevClose": "1304.2",
  "LowVal": "1285",
  "HighVal": "1305",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "800000",
  "Data": "[{\"dttm\":\"Fri Jun 05 2026 16:01:32\",\"vale1\":\"1291.20\",\"vole\":\"0\"},{\"dttm\":\"Fri Jun 05 2026 16:00:02\",\"vale1\":\"1291.20\",\"vole\":\"0\"},{\"dttm\":\"Fri Jun 05 2026 15:59:26\",\"vale1\":\"1291.20\",\"vole\":\"42\"},{\"dttm\":\"Fri Jun 05 2026 15:58:48\",\"vale1\":\"1291.20\",\"vole\":\"30\"},{\"dttm\":\"Fri Jun 05 2026 15:57:43\",\"vale1\":\"1291.20\",\"vole\":\"0\"},{\"dttm\":\"Fri Jun 05 2026 15:56:51\",\"vale1\":\"1291.20\",\"vole\":\"25\"},{\"dttm\":\"Fri Jun 05 2026 15:55:57\",\"vale1\":\"1291.20\",\"vole\":\"0\"},{\"dttm\":\"Fri Jun 05…[truncated, total 32303 chars]
```
...
Reference&#32;&#35;18&#46;4c0dc617&#46;1780693095&#46;48b75ca
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;4c0dc617&#46;1780693095&#46;48b75ca</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 811333 chars]
```
...
```
<!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=Edge"><meta name="robots" content="noindex,nofollow"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="content-security-policy" content="default-src &#39;none&#39;; script-src &#39;nonce-RZIBSq4SnVljyqkpTIRE3y&#39; &#39;unsafe-eval&#39; https://challenges.cloudflare.com; script-s…[truncated, total 5747 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=265948 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=148154 | sme: static status=200 bytes=148353 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=318882 | detail-2: static status=200 bytes=326010 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=2 | d1: main=93248b tables=11 rows=83 | d2: main=89797b tables=12 rows=77
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=266152 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> details_extracted=3 | avg_full=0.818 | avg_narrow=0.933 | pdf_on_allowlist=2 | pdf_off_allowlist=3 | third_ipo=hexagon-nutrition-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.73 narrow=0.80 | d3:hexagon-nutrition-ipo full=0.82 narrow=1.00
