...
Generated: 2026-09-17T15:33:34.046Z
...
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 959 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 878 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2155 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 330 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 4293 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11232 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 13028 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 392 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 584 | Deterministic mapping; no manual override file needed for v1. |
| P-06 | BSE — Mainboard Public Issues | RED | 200 | HTML | 688 | Skip; NSE primary covers this. |
...
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 553 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 108 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 1010 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 899 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 674 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 229 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1430 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 637 | Skip; Phase 6 stays off if all GMP probes fail. |
...
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 5130 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 7701 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1172 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 965 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 3468 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 5460 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 175 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 342 ms
- Ran at (UTC): 2026-09-17T15:32:14.212Z

> Total rows: 7, Active rows: 5

```
{
  "companyName": "National Stock Exchange of India Limited",
  "issueEndDate": "21-Sep-2026",
  "issuePrice": "Rs.1700 to Rs.1785",
  "issueSize": "88642911",
...
> Total rows: 7, Forthcoming/upcoming rows: 1
...
- URL: `https://www.nseindia.com/api/ipo-current-issue?symbol=NSE`
...
> Active candidate symbol: NSE · Top-level keys: 0, 1, 2, 3, 4, 5, 6
...
[
  {
    ...
    "symbol": "NSE",
    "category": "Total",
    "noOfSharesOffered": "8.8642911E7",
    "noOfTime": "0.2896917498569062",
    "noOfsharesBid": "2.567912E7",
    "srNo": null
  },
  {
    ...
    "symbol": "SONA",
    "category": "Total",
    "noOfSharesOffered": "1.001E7",
    "noOfTime": "0.3457192807192807",
    "noOf…[truncated, total 2722 chars]
```
...
> [static-primary] static ok: tr=0, bytes=6035 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=44522 (pdfs=14)
...
```
{
  ...
  "first_3_pdfs": [
    {
      "url": "https://www.sebi.gov.in/sebi_data/commondocs/sep-2026/IBERIA%20PHARMACEUTICALS%20INDIA%20LIMITED_p.pdf",
      "link_text": "IBERIA PHARMACEUTICALS INDIA LIMITED- Draft Abridged Prospectus",
      "source": "static-alt"
    },
    {
...
> discovery=sebi-publicissues-pdfs.json; pdf_url=cs/sep-2026/IBERIA%20PHARMACEUTICALS%20INDIA%20LIMITED_p.pdf; bytes=608768; page_count=13; pdf-parse=ok
...
```
{
  ...
  "link_text": "IBERIA PHARMACEUTICALS INDIA LIMITED- Draft Abridged Prospectus",
  "bytes": 608768,
  "sha256": "2644326ca6ce75c4…",
  "magic": "%PDF",
  "page_count": 13,
  "cover_text_first_200": "(Please scan the QR code to view this Draft Abridged Prospectus)\nIBERIA PHARMACEUTICALS INDIA LIMITED\nCORPORATE IDENTITY NUMBER: U21002DL2013PLC250040\nREGISTERED CORPORATE CONTACT E-MAIL AND\nWEBSITE\nO"
}
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22095 chars] ; [bse:RELIANCE] BSE rows=26329, fields=1

```
{
  "CurrDate": "Thu Sep 17 2026 16:01:24",
  "PrevClose": "1241.4",
  "LowVal": "1235",
  "HighVal": "1255",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "500000",
  "Data": "[{\"dttm\":\"Thu Sep 17 2026 16:01:24\",\"vale1\":\"1240.80\",\"vole\":\"0\"},{\"dttm\":\"Thu Sep 17 2026 16:00:07\",\"vale1\":\"1240.80\",\"vole\":\"0\"},{\"dttm\":\"Thu Sep 17 2026 15:59:59\",\"vale1\":\"1240.80\",\"vole\":\"0\"},{\"dttm\":\"Thu Sep 17 2026 15:58:49\",\"vale1\":\"1240.80\",\"vole\":\"2\"},{\"dttm\":\"Thu Sep 17 2026 15:57:10\",\"vale1\":\"1240.80\",\"vole\":\"0\"},{\"dttm\":\"Thu Sep 17 2026 15:56:58\",\"vale1\":\"1240.80\",\"vole\":\"10\"},{\"dttm\":\"Thu Sep 17 2026 15:55:58\",\"vale1\":\"1240.80\",\"vole\":\"1\"},{\"dttm\":\"Thu Sep 17 2…[truncated, total 31271 chars]
```
...
Reference&#32;&#35;18&#46;670f3417&#46;1789659169&#46;e8ae7462
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;670f3417&#46;1789659169&#46;e8ae7462</P>
</BODY>
</HTML>
...
```
{
  ...
  "Axiom Gas Engineering Limited": "AXIOMGAS"
}
```
...
```
{
  ...
  "Axiom Gas Engineering Limited": null
}
```
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 972011 chars]
```
...
> <tr> count: 0, bytes=569169

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP Today 2026 – Live Grey Market Premium &amp; Kostak Rates - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-cfasync="fa…[truncated, total 569169 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=347228 | rendered_len=391896 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
<H1>Access Denied</H1>
 …[truncated, total 399 chars] ; [NSE IPO list] 7 IPOs; per-row keys: companyName, issueEndDate, issuePrice, issueSize, issueStartDate, series, status, symbol; sector fields: (none) ; [BSE IPO list] BSE HTML; sector-related words found: (none); bytes=14287
...
> mainboard: static status=200 bytes=152320 | sme: static status=200 bytes=149899 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=294839 | detail-2: static status=200 bytes=234665 | challenges_detected=false
...
```
{
  ...
  "picked_detail_urls": [
    ...
    "https://www.chittorgarh.com/ipo/elevate-campuses-ipo/2647/"
  ],
  "detail_titles": [
    "A-One Steels IPO Date, Price, GMP, Review, Details",
    "Elevate Campuses IPO Date, Price, GMP, Review, Details"
  ],
...
- Response type: JSON
- Fields found: d1.company_name[high], d1.issue_size_cr[high], d1.price_band[high], d1.lot_size[high], d1.listing_date[high], d2.company_name[high], d2.issue_size_cr[high], d2.listing_date[high], d2.official_pdf_links[high]
- Fields missing: d1.open_date[missing], d1.close_date[missing], d1.registrar[missing], d1.brlms[missing], d1.official_pdf_links[rejected-low], d2.price_band[missing], d2.lot_size[missing], d2.open_date[missing], d2.close_date[missing], d2.registrar[missing], d2.brlms[missing]
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
> details_extracted=2 | avg_precision=0.450 | official_pdf_links_on_allowlist=1 | official_pdf_links_off_allowlist=1 | d1: main=88067b tables=13 rows=73 | d2: main=73398b tables=8 rows=39
  ...
  "details": [
    {
      ...
      "precision_ratio": 0.5,
      "tables_parsed": 13,
      "table_rows_parsed": 73
    },
    {
      "index": 2,
      "source_url": "https://www.chittorgarh.com/ipo/elevate-campuses-ipo/2647/",
      "found_count": 4,
      "precision_ratio": 0.4,
      "tables_parsed": 8,
      "table_rows_parsed": 39
    }
  ]
}
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=347228 | rendered_len=391891 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
- Status code: 200
- Response type: HTML
- Fields found: detail-1 reachable (static), detail-2 reachable (static), detail-3 reachable (static), third IPO selection: current (nse-ipo)
- Fields missing: (none)
- Parsing difficulty: Medium
- Anti-bot risk: Low
- Legal/ToS risk: Medium
...
```
{
  ...
  "detail_titles": [
    ...
    {
      "index": 3,
      "title": "NSE IPO Date, Price, GMP, Review, Analysis &amp; Details"
    }
  ],
  "challenges_detected": false
}
...
> details_extracted=3 | avg_full=0.848 | avg_narrow=1.000 | pdf_on_allowlist=2 | pdf_off_allowlist=1 | third_ipo=nse-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.82 narrow=1.00 | d3:nse-ipo full=0.82 narrow=1.00
