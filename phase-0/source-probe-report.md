...
Generated: 2026-07-30T05:53:35.926Z
...
|---|---|---|---|---|---|---|
| P-01 | NSE — Current/Open IPOs | GREEN | 200 | JSON | 477 | Use as primary source for Live & Upcoming tab. |
| P-02 | NSE — Upcoming IPOs | GREEN | 200 | JSON | 321 | Use as primary for Upcoming/Pipeline tab. |
| P-03 | NSE — Past/Recent IPOs | GREEN | 200 | JSON | 60 | Use as primary for Recently Listed. |
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 354 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 923 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2206 | Use as primary for Pipeline tab + DRHP master. |
...
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2981 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11635 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 4084 | NSE historical still blocked; use BSE historical as primary (official fallback). |
| P-15b | NSE — Equity Quote | RED | 403 | BLOCKED | 50 | Fall back to BSE quote. |
| P-16 | Ticker mapping (NSE list symbol field) | GREEN | 200 | JSON | 275 | Deterministic mapping; no manual override file needed for v1. |
...
| P-07 | BSE — Subscription / Cumulative Bid Details | RED | 200 | HTML | 918 | Rely on NSE only (P-04). |
...
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 5863 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 897 | Store URL as link-out only. |
| P-17 | RHP PDF parsing — sample | YELLOW | 200 | EMPTY | 999 | PDF discovery selector may have drifted. |
| P-18 | Anchor circular PDF parsing — sample | YELLOW | 200 | EMPTY | 251 | PDF discovery selector may have drifted. |
| P-19 | GMP — IPOWatch | YELLOW | 200 | HTML | 1524 | Include in Phase 6 GMP averager. |
| P-20 | GMP — Chittorgarh | RED | 200 | HTML | 878 | Skip; Phase 6 stays off if all GMP probes fail. |
| P-21 | GMP — IPO Central | YELLOW | 200 | HTML | 108 | Include in Phase 6 GMP averager (lower weight given parsing difficulty). |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 196 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 5092 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4509 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1616 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 1645 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 5222 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-28 | Upstox — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4414 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-25b | Chittorgarh — detail-page accessibility retune (Phase 6A.1) | GREEN | 200 | HTML | 22531 | All 3 detail pages captured cleanly. Run P-26b to evaluate per-field extraction precision. |
...
- Fallback: P-06
- Latency: 477 ms
- Ran at (UTC): 2026-07-30T05:52:00.083Z
...
[
  {
    ...
    "noOfTime": "0.6243138855987387",
    "noOfsharesBid": "2489446.0",
    "srNo": null
  },
  {
    ...
    "noOfTime": "0.025110974884900647",
    "noOfshares…[truncated, total 1273 chars]
```
...
> [static-primary] static ok: tr=0, bytes=6080 (pdfs=0) ; [static-alt] static ok: tr=26, bytes=46208 (pdfs=20)
...
> discovery=sebi-publicissues-pdfs.json; pdf_url=/commondocs/jul-2026/Indian%20Gas%20Exchange%20Limited_p.pdf; bytes=468322; page_count=12; pdf-parse=ok
...
```
{
  ...
  "link_text": "Indian Gas Exchange Limited - Draft Abridged prospectus",
  "bytes": 468322,
  "sha256": "1c01ddfcde4e620d…",
  "magic": "%PDF",
  "page_count": 12,
  "cover_text_first_200": "INDIAN GAS EXCHANGE LIMITED\nCorporate Identity Number: U74999DL2019PLC357145\nREGISTERED CORPORATE CONTACT PERSON EMAIL AND WEBSITE\nOFFICE OFFICE TELEPHONE\n1st Floor, Unit No. Plot No. C-001/A/1,6th Pr"
}
```
...
<html lang="en">
<head>
<meta content="noindex, nofollow" name=…[truncated, total 22098 chars] ; [bse:RELIANCE] BSE rows=8599, fields=1

```
{
  "CurrDate": "Thu Jul 30 2026 11:21:59",
  "PrevClose": "1276",
  "LowVal": "1275",
  "HighVal": "1290",
  "Scripname": "RELIANCE",
  ...
  "LowVol": "0",
  "HighVol": "30000",
  "Data": "[{\"dttm\":\"Thu Jul 30 2026 11:21:59\",\"vale1\":\"1285.50\",\"vole\":\"6423\"},{\"dttm\":\"Thu Jul 30 2026 11:20:59\",\"vale1\":\"1285.00\",\"vole\":\"1084\"},{\"dttm\":\"Thu Jul 30 2026 11:19:59\",\"vale1\":\"1285.50\",\"vole\":\"351\"},{\"dttm\":\"Thu Jul 30 2026 11:18:59\",\"vale1\":\"1286.40\",\"vole\":\"12669\"},{\"dttm\":\"Thu Jul 30 2026 11:17:59\",\"vale1\":\"1285.85\",\"vole\":\"13167\"},{\"dttm\":\"Thu Jul 30 2026 11:16:59\",\"vale1\":\"1285.80\",\"vole\":\"276\"},{\"dttm\":\"Thu Jul 30 2026 11:15:59\",\"vale1\":\"1285.15\",\"vole\":\"7151\"},{\"dttm…[truncated, total 10358 chars]
```
...
Reference&#32;&#35;18&#46;aebd7768&#46;1785390745&#46;65fb2ae
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;aebd7768&#46;1785390745&#46;65fb2ae</P>
</BODY>
</HTML>
...
<head><style>img.lazy{min-height:1px}</style><link href="https://ipowatch.in/wp-content/plugins/w3-total-cache/pub/js/lazyload.min.js" as="script">
	...
	<!-- This site is optimized with the Yoast SEO Premium p…[truncated, total 867566 chars]
```
...
> <tr> count: 20, bytes=333498

```
<!doctype html >
<!--[if IE 8]><html class="ie8" lang="en"> <![endif]-->
<!--[if IE 9]><html class="ie9" lang="en"> <![endif]-->
<!--[if gt IE 8]><!--><html lang="en-US" prefix="og: https://ogp.me/ns#"> <!--<![endif]--><head><title>IPO GMP 2026 - IPO Grey Market Premium, Latest GMP &amp; Kostak - IPO Central</title><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="pingback" href="https://ipocentral.in/xmlrpc.php" /> <script data-no-defer="1"…[truncated, total 333498 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=232933 | rendered_len=273305 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
<H1>Access Denied</H1>
 …[truncated, total 397 chars] ; [NSE IPO list] 3 IPOs; per-row keys: companyName, issueEndDate, issuePrice, issueSize, issueStartDate, series, status, symbol; sector fields: (none) ; [BSE IPO list] BSE HTML; sector-related words found: (none); bytes=13850
...
> mainboard: static status=200 bytes=149240 | sme: static status=200 bytes=149429 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=271317 | detail-2: static status=200 bytes=315544 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=1 | d1: main=81333b tables=11 rows=61 | d2: main=89760b tables=11 rows=70
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=232933 | rendered_len=273989 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> details_extracted=3 | avg_full=0.848 | avg_narrow=1.000 | pdf_on_allowlist=2 | pdf_off_allowlist=0 | third_ipo=mv-electrosystems-ipo(current) | d1:onemi-technology-ipo full=0.91 narrow=1.00 | d2:bagmane-reit full=0.82 narrow=1.00 | d3:mv-electrosystems-ipo full=0.82 narrow=1.00
