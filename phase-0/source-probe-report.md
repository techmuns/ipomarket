...
Generated: 2026-07-10T13:20:44.593Z
...
| P-04 | NSE — Live Subscription | RED | 200 | JSON | 274 | Fall back to BSE bidding (P-07). |
| P-05 | NSE Emerge — SME IPOs | YELLOW | 200 | JSON | 652 | Source reachable; 0 SME rows in current snapshot. |
| P-08 | SEBI — Public Issues Filings | GREEN | 200 | HTML | 2123 | Use as primary for Pipeline tab + DRHP master. |
| P-08b | SEBI — Processing Status | YELLOW | 200 | EMPTY | 554 | Endpoint reachable; show "no observations today" in Pipeline tab when empty. |
| P-09 | SEBI — DRHP PDF Download | GREEN | 200 | PDF | 2748 | PDF download pipeline viable; proceed to Phase 5 RHP parsing (P-17). |
| P-10 | NSE/BSE — DRHP Archive | RED | 200 | HTML | 11086 | Skip if SEBI (P-08) is GREEN. |
| P-15 | BSE — Historical OHLC (fallback) | GREEN | 200 | JSON | 3001 | NSE historical still blocked; use BSE historical as primary (official fallback). |
...
| P-12 | MUFG Intime (Link Intime) — landing | GREEN | 200 | HTML | 350 | Store URL as link-out; do not scrape per-PAN. |
| P-13 | KFintech — landing | GREEN | 200 | HTML | 47 | Store URL as link-out only. |
| P-14 | Bigshare — landing | GREEN | 200 | HTML | 5386 | Store URL as link-out only. |
| P-14b | Maashitla — landing | GREEN | 200 | HTML | 1200 | Store URL as link-out only. |
...
| P-21 | GMP — IPO Central | RED | 403 | BLOCKED | 56 | Skip. |
| P-22 | GMP — InvestorGain | YELLOW | 200 | HTML | 253 | Include in Phase 6 GMP averager. |
| P-23a | Broker IPO page — Zerodha (reference only) | GREEN | 200 | HTML | 4723 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-23b | Broker IPO page — Upstox (reference only) | GREEN | 200 | HTML | 4991 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
| P-24 | Sector / industry classification (NSE + BSE) | RED | 403 | EMPTY | 1325 | Sector unreachable from probed endpoints; manual sector-map.json required for v1. |
| P-25 | Chittorgarh — IPO list + detail accessibility (Phase 5C) | GREEN | 200 | HTML | 1705 | Run P-26 to evaluate field extraction precision against the captured HTML (detail_discovery_source=static). |
...
| P-27 | Zerodha — IPO detail refresh (Phase 5C, reference only) | GREEN | 200 | HTML | 4134 | Use as information-architecture benchmark only. Do NOT scrape for production data. |
...
- Fallback: P-06
- Latency: 323 ms
- Ran at (UTC): 2026-07-10T13:19:36.756Z
...
Reference&#32;&#35;18&#46;ba7cb17&#46;1783689598&#46;4724fee
<P>https&#58;&#47;&#47;errors&#46;edgesuite&#46;net&#47;18&#46;ba7cb17&#46;1783689598&#46;4724fee</P>
</BODY>
</HTML>
...
<head>
	...
	<title>IPO GMP Today, Live IPO Grey Market Premiu…[truncated, total 821316 chars]
```
...
```
<!DOCTYPE html><html lang="en-US"><head><title>Just a moment...</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=Edge"><meta name="robots" content="noindex,nofollow"><meta name="viewport" content="width=device-width,initial-scale=1"><meta http-equiv="content-security-policy" content="default-src &#39;none&#39;; script-src &#39;nonce-4qT3csuutGlcET3cz41BKf&#39; &#39;unsafe-eval&#39; https://challenges.cloudflare.com; script-s…[truncated, total 5747 chars]
```
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=268107 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
...
> mainboard: static status=200 bytes=147631 | sme: static status=200 bytes=147335 | detail_urls_discovered=40 | detail_discovery_source=static | detail_urls_picked=2 | detail-1: static status=200 bytes=274289 | detail-2: static status=200 bytes=287044 | challenges_detected=false
...
> details_extracted=2 | avg_precision=0.500 | official_pdf_links_on_allowlist=0 | official_pdf_links_off_allowlist=1 | d1: main=81669b tables=9 rows=54 | d2: main=85518b tables=10 rows=69
...
> final_url=https://upstox.com/ipo/vegorama-punjabi-angithi-limited-ipo/ | title=Vegorama Punjabi Angithi Limited IPO - Check IPO Date, Details, Price & Allotmen | render_mode=server-rendered | raw_len=225612 | rendered_len=268111 | challenge=false | headings=20 | tables=1 | doc_links=8 | labels=11
